...
/**
 * Represents the Strange Old Man dialogue plugin.
 */
@Initializable
class StrangeOldManDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    /*
    if (inInventory(player, Items.JENNICAS_RING_13566)) {
        when (stage) {
            1 -> npcl(FacialExpression.SCARED, "The...ring...Jennica...").also { stage++ }
            2 -> playerl(FacialExpression.HALF_ASKING, "How do you know about Jennica?").also { stage++ }
            3 -> npcl(FacialExpression.SAD, "Jennica... Dig, dig, dig... Dig...").also { stage = END_DIALOGUE }
        }
    }
    */
    ...
    */
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return StrangeOldManDialogue(player)
    }
