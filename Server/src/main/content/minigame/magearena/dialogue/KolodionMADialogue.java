...
/**
 * Represents the Kolodion dialogue plugin for Mage Arena minigame.
 */
public final class KolodionMADialogue extends DialoguePlugin {

	public KolodionMADialogue() {

	}

	public KolodionMADialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new KolodionMADialogue(player);
	}
