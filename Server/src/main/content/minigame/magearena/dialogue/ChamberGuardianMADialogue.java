...
/**
 * Represents the Chamber Guardian dialogue plugin for Mage Arena minigame.
 */
public final class ChamberGuardianMADialogue extends DialoguePlugin {
	...
	public ChamberGuardianMADialogue() {

	}

	public ChamberGuardianMADialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new ChamberGuardianMADialogue(player);
	}
