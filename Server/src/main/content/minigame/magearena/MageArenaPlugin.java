...
import content.minigame.magearena.dialogue.ChamberGuardianMADialogue;
import content.minigame.magearena.dialogue.KolodionMADialogue;
import content.minigame.magearena.npc.KolodionNPC;
import content.minigame.magearena.npc.MageArenaNPC;
...
public final class MageArenaPlugin extends OptionHandler {
	...
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		...
		ClassScanner.definePlugin(new KolodionMADialogue());
		ClassScanner.definePlugin(new ChamberGuardianMADialogue());
	...
	public void handlePool(final Player player, boolean enter, final Location dest, final Scenery object) {
		...
		removeAttribute(player, "mc-loc");
		removeAttribute(player, "mb-dir");
		if (enter) {
