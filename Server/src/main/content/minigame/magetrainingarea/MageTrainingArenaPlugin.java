...
import content.minigame.magetrainingarea.dialogue.*;
...
public class MageTrainingArenaPlugin extends OptionHandler {
	...
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		...
		ClassScanner.definePlugins(new CharmedWarriorMTADialogue(), new EntranceGuardianMTADialogue(), new RewardsGuardianMTADialogue(), new ProgressHatMTADialogue(), new EnchantmentGuardianMTADialogue(), new EnchantSpell(),  new GraveyardGuardianMTADialogue(), new AlchemyGuardianMTADialogue(), new TelekineticGrabSpell(), new TelekineticGuardianMTADialogue(), new MazeGuardianMTADialogue());
		return this;
	}
