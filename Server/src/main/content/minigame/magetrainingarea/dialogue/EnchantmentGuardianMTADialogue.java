...
/**
 * Represents the Enchantment Guardian dialogue plugin for Mage Training Area.
 */
public class EnchantmentGuardianMTADialogue extends DialoguePlugin {

	public EnchantmentGuardianMTADialogue() {

	}

	public EnchantmentGuardianMTADialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new EnchantmentGuardianMTADialogue(player);
	}
