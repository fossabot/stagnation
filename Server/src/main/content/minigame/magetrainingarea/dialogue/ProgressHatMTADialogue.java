...
/**
 * Represents the Progress Hat dialogue plugin for Mage Training Area.
 */
public class ProgressHatMTADialogue extends DialoguePlugin {
	...
	public ProgressHatMTADialogue() {

	}

	public ProgressHatMTADialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new ProgressHatMTADialogue(player);
	}
