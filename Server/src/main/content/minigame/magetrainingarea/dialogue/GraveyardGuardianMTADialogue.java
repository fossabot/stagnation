...
/**
 * Represents the Graveyard Guardian dialogue plugin for Mage Training Area.
 */
public class GraveyardGuardianMTADialogue extends DialoguePlugin {

	public GraveyardGuardianMTADialogue() {

	}

	public GraveyardGuardianMTADialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new GraveyardGuardianMTADialogue(player);
	}
