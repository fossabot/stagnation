...
/**
 * Represents the Alchemy Guardian dialogue plugin for Mage Training Area.
 */
public class AlchemyGuardianMTADialogue extends DialoguePlugin {

	public AlchemyGuardianMTADialogue() {

	}

	public AlchemyGuardianMTADialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new AlchemyGuardianMTADialogue(player);
	}
