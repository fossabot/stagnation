...
/**
 * Represents the Telekinetic Guardian dialogue plugin for Mage Training Area.
 */
public class TelekineticGuardianMTADialogue extends DialoguePlugin {

	public TelekineticGuardianMTADialogue() {

	}

	public TelekineticGuardianMTADialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new TelekineticGuardianMTADialogue(player);
	}
