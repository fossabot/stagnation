...
/**
 * Represents the Entrance Guardian dialogue plugin for Mage Training Area.
 */
public class EntranceGuardianMTADialogue extends DialoguePlugin {

	public EntranceGuardianMTADialogue() {

	}

	public EntranceGuardianMTADialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new EntranceGuardianMTADialogue(player);
	}
