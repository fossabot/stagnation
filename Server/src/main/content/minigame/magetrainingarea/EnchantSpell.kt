...
import config.Items
import content.minigame.magetrainingarea.impl.EnchantingZone.Shapes
        ...
        if (entity.zoneMonitor.isInZone("Enchantment Chamber")) {
            ...
            if (target.id == 6903) {
                ...
                if (shape != null) {
                    ...
                    if (shape == content.minigame.magetrainingarea.impl.EnchantingZone.BONUS_SHAPE) {
                        pizazz += 1
            ...
            if (pizazz != 0) {
                content.minigame.magetrainingarea.impl.EnchantingZone.ZONE.incrementPoints(entity, content.minigame.magetrainingarea.MTAType.ENCHANTERS.ordinal, pizazz)
            }
        }
        return true
    }
