...
/**
 * Represents the Beacon Tender dialogue plugin for All Fired Up minigame.
 */
@Initializable
...
class BeaconTenderAFUminiDialogue(player: Player? = null) : DialoguePlugin(player) {
    var index = 0

    override fun newInstance(player: Player?): DialoguePlugin {
        return BeaconTenderAFUminiDialogue(player)
    }
