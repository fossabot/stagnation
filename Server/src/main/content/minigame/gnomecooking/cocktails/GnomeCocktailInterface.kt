...
class GnomeCocktailInterface : ComponentPlugin() {
    ...
    internal enum class FruitCocktail(val levelReq: Int, val experience: Double, val product: Int, val requiredItems: Array<Item>){
        ...
        WIZARD_BLIZZARD(18,110.0, 9566, arrayOf(Item(Items.VODKA_2015,2),Item(Items.GIN_2019),Item(Items.LIME_2120),Item(
            Items.LEMON_2102),Item(Items.ORANGE_2108))),
        ...
        CHOC_SATURDAY(33,170.0,9571, arrayOf(Item(Items.WHISKY_2017),Item(Items.CHOCOLATE_BAR_1973),Item(Items.EQUA_LEAVES_2128),Item(
            Items.BUCKET_OF_MILK_1927))),
        BLURBERRY_SPEC(37,180.0,9570, arrayOf(Item(Items.VODKA_2015),Item(Items.BRANDY_2021),Item(Items.GIN_2019),Item(
            Items.LEMON_2102,2),Item(Items.ORANGE_2108)))
    }
