...
/**
 * Represents the Outpost Squire dialogue plugin for Pest Control minigame.
 */
@Initializable
public final class OutpostSquireDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 5:
			...
			break;
		case 6:
			npc("The Void Knights, they are great warriors of balance", "who do Guthix's work here in " + GameWorld.getSettings().getName() + ".");
			stage = 11;
			break;
		case 11:
			options("Wow, can I join?", "What kind of work?", "What's " + GameWorld.getSettings().getName() + "?","Uh huh, sure.");
			stage = 12;
			break;
		case 12:
			switch (buttonId) {
			...
			case 2:
				...
				break;
			case 3:
				player("What's " + GameWorld.getSettings().getName() + "?");
				stage = 15;
				break;
			case 4:
				player("Uh huh, sure.");
		...
		case 16:
			...
			break;
		case 17:
			npc("Ah well you see we try to keep " + GameWorld.getSettings().getName() + " as Guthix", "intended, it's very challenging. Actually we've been", "having some problems recently, maybe you could help", "us?");
			stage = 18;
			break;
		case 18:
			options("Yeah ok, what's the problem?", "What's "+ GameWorld.getSettings().getName() + "?" , "I'd rather not, sorry.");
			stage = 19;
			break;
		case 19:
			switch (buttonId) {
