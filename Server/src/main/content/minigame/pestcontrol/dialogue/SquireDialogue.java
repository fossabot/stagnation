...
/**
 * Represents the Squire dialogue plugin for Pest Control minigame.
 */
@Initializable
public class SquireDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 11:
			...
			break;
		case 12:
			interpreter.sendDialogues(npc, FacialExpression.HALF_GUILTY, "The Void Knights, they are great warriors of balance", "who do Guthix's work here in " + GameWorld.getSettings().getName() + ".");
			stage = 13;
			break;
		case 13:
			end();
