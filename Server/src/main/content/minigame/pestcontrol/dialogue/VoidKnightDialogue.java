...
/**
 * Represents the Void Knight dialogue plugin for Pest Control minigame.
 */
@Initializable
public final class VoidKnightDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 16:
			...
			break;
		case 17:
			npc("Ah well you see we try to keep " + GameWorld.getSettings().getName() + " as Guthix",
			...
			break;
		case 18:
			options("Yeah ok, what's the problem?", "What's 'RuneScape'?",
