package content.minigame.castlewars.npc
            ...
            openDialogue(player, object : DialogueFile(){
                override fun handle(componentID: Int, buttonID: Int) {
                    when(stage) {
                        ...
                        2 -> options("What is this place?", "What do you have for trade?", "Do you have a manual? I'd like to learn how to play!").also { stage++ }
                        3 -> when (buttonID) {
