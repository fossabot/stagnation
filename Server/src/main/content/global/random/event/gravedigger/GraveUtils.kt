...
/**
 * Utils for Gravedigger random event.
 */
object GraveUtils {
    ...
    fun teleport(player: Player) {
        setAttribute(player, LEO_LOCATION, player.location)
        registerLogoutListener(player, LEO_LOGOUT) { p ->
            p.location = getAttribute(p,LEO_LOCATION, player.location)
        }
