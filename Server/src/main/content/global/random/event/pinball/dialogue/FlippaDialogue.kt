...
/**
 * Represents the Flippa dialogue for Pinball random event.
 */
class FlippaDialogue : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        npc = NPC(NPCs.FLIPPA_3912)
        when (stage) {
            ...
            100 -> {
                ...
                Component.setUnclosable(player, player!!.dialogueInterpreter.sendPlainMessage(true, "", "Tag the post with the " + core.tools.BLUE + "flashing rings.",))
                unlock(player!!)
            }
        }
    }
