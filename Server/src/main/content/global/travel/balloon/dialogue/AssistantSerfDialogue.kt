...
/**
 * Represents the Assistant Serf dialogue plugin used for Balloon traveling.
 */
@Initializable
class AssistantSerfDialogue(player: Player? = null) : DialoguePlugin(player) {
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (stage) {
            ...
            3 -> npcl(FacialExpression.FRIENDLY,"I am a Serf. Assistant Serf to you! Auguste freed me and gave me this job.").also { stage++ }
            ...
            7 -> {
                ...
                setComponentVisibility(player,Components.ZEP_BALLOON_MAP_469,21, false)
            }
        }
        return true
    }
    ...
    override fun getIds(): IntArray {
        return intArrayOf(NPCs.ASSISTANT_SERF_5053)
    }
}