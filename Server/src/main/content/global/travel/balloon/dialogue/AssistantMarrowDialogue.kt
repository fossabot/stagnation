...
/**
 * Represents the Assistant Marrow dialogue plugin used for Balloon traveling.
 */
@Initializable
class AssistantMarrowDialogue(player: Player? = null) : DialoguePlugin(player) {
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (stage) {
            ...
            3 -> npcl(FacialExpression.FRIENDLY,"I am Assistant Marrow. I'm working here part time while I study to be a doctor.").also { stage++ }
            ...
            7 -> {
                ...
                setComponentVisibility(player,Components.ZEP_BALLOON_MAP_469,24, false)
            }
        }
        return true
    }
    ...
    override fun getIds(): IntArray {
        return intArrayOf(NPCs.ASSISTANT_MARROW_5055)
    }
}