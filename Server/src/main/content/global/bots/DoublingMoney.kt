...
class DoublingMoney : Script() {
    ...
    var states = mapOf(
        ...
        fun(): Int {
            ...
            if (botTradeModule.getInterface() == TradeModule.ACCEPT_INTERFACE) {
                ...
                setAttribute(player, "double-money-net-pol", playerNetPoL.toString())
    ...
    companion object {
        ...
        // load from data/botdata/ai_equipment.json
        private val jsonFilePath = "${ServerConstants.BOT_DATA_PATH}/ai_equipment.json"
