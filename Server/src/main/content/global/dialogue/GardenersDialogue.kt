...
import config.Items
import content.global.skill.member.farming.FarmerPayOptionDialogue
import content.global.skill.member.farming.Farmers
...
/**
 * Represents the Gardener dialogue plugin.
 */
@Initializable
class GardenersDialogue(player: Player? = null) : DialoguePlugin(player) {
    override fun newInstance(player: Player?): DialoguePlugin {
        return GardenersDialogue(player)
    }
