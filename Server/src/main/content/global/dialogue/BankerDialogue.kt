...
/**
 * Represents the Banker dialogue plugin.
 */
@Initializable
class BankerDialogue(player: Player? = null) : DialoguePlugin(player) {
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            3 -> npcl(FacialExpression.FRIENDLY, "This is a branch of the Bank of Gielinor. We have branches in many towns.").also { stage++ }
