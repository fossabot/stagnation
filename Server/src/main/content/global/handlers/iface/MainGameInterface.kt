...
class MainGameInterface : InterfaceListener {
    ...
    override fun defineInterfaceListeners() {
        ...
        on(TOPLEVEL_FS){player, _, _, buttonID, _, _ ->
            when (buttonID) {
                12 -> setInterfaceText(player, "When you have finished playing " + settings!!.name + ", always use the button below to logout safely. ", 182, 0)
                49 -> setInterfaceText(player, "Friends List - " + settings!!.name + " " + settings!!.worldId, 550, 3)
