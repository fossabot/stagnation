...
/**
 * Represents the Item Quest Requirement listener.
 */
class ItemQuestRequirementListener : InteractionListener {
    ...
    private val fremennikTrialsEquipment = intArrayOf(
        Items.BERSERKER_HELM_3751, Items.BERSERKER_HELM_13408, Items.BERSERKER_HELM_E_12674, Items.BERSERKER_HELM_CHARGED_12675,
    ...
    private val questCapes = intArrayOf(Items.QUEST_POINT_HOOD_9814,Items.QUEST_POINT_CAPE_9813)
    ...
    override fun defineListeners() {
        ...
        onEquip(fremennikIslesDuringQuestEquipment){ player, _ ->
            if (getQuestStage(player, "Fremennik Isles") > 0) {
