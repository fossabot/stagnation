        ...
        private val CONTENTS = arrayOf(
            PageSet(
                Page(
                    ...
                    BookLine("Resources Your loyal", 64),
                    BookLine("subjects will work hard", 65),
                ),
                Page(
                    BookLine("to gather resources", 66),
                    ...
                    BookLine("if more resources have", 76),
                )
            ),
            PageSet(
                Page(
                    ...
                    BookLine("amount of resources gathered", 64),
            ...
            PageSet(
                Page(
                    ...
                    BookLine("to gather resources for you.", 65),
                ),
                Page(
