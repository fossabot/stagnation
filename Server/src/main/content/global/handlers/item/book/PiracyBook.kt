...
/**
 * Pirate Book handler for the 'Cabin Fever' quest.
 */
class PiracyBook : InteractionListener {
        ...
        private val CONTENTS = arrayOf(
            ...
            PageSet(
                ...
                Page(
                    ...
                    BookLine("can also include", 69),
                    BookLine("(but are not limited to)", 70),
                    BookLine("cutlasses and scimitars,", 71),
                    BookLine("pirate hats, face masks,", 72),
                    BookLine("bandanas and flashy", 73),
                    BookLine("jewellery.", 74),
            ...
            PageSet(
                ...
                Page(
                    ...
                    BookLine("for a reasonable sum of money.", 75),
                )
            ),
            PageSet(
                Page(
                ...
                Page(
                    ...
                    BookLine("agreement with your statement.", 68),
            ...
            PageSet(
                ...
                Page(
                    ...
                    BookLine("2. A pirate of great size.", 74),
                    BookLine("I'm not a pirate,", 75),
                    BookLine("<col=08088A>I'm a privateer</col> -> I am a pirate,", 76),
                )
            ),
            PageSet(
                Page(
            ...
            PageSet(
                Page(
                    ...
                    BookLine("<col=08088A>Davy's Grip -></col> Popular drinking", 60),
                    BookLine("game involving mangoes,", 61),
                    BookLine("a hammer, and all the", 62),
                    BookLine("corkscrews that players", 63),
                    BookLine("can get their hands on.", 64),
                )
            ),
        )
    }
