package content.global.skill.free.fishing
...
enum class FishingOption(val tool: Int, val level: Int, val animation: Animation, val bait: IntArray?, val option: String, vararg val fish: Fish) {
    ...
    BAIT(
        Items.FISHING_ROD_307, 5, Animation(622), intArrayOf(Items.FISHING_BAIT_313), "bait",
        Fish.SARDINE,
        Fish.HERRING
    ),
    LURE(
        Items.FLY_FISHING_ROD_309, 20, Animation(622), intArrayOf(Items.FEATHER_314, Items.STRIPY_FEATHER_10087), "lure",
        Fish.TROUT,
        Fish.SALMON,
        Fish.RAINBOW_FISH
    ),
    ...
    BIG_NET(
        Items.BIG_FISHING_NET_305, 16, Animation(620), null, "net",
        Fish.MACKEREL,
        Fish.COD,
        Fish.BASS,
        Fish.SEAWEED
    ...
    KARAMBWAN_VES(
        Items.KARAMBWAN_VESSEL_3157, 65, Animation(1193), intArrayOf((Items.RAW_KARAMBWANJI_3150)), "fish",
        Fish.KARAMBWAN
    ),
    OILY_FISHING_ROD(
        Items.OILY_FISHING_ROD_1585, 53, Animation(622), intArrayOf(Items.FISHING_BAIT_313), "bait",
        Fish.LAVA_EEL
    );
