package content.global.skill.free.smithing;
...
public class SmithingPulse extends SkillPulse<Item> {
    ...
    public boolean checkRequirements() {
        ...
        if (!hasRequirement(player,"The Tourist Trap", false) && bar.getSmithingType() == SmithingType.TYPE_DART_TIP) {
    ...
    public void animate() {
        if(SkillcapePerks.isActive(SkillcapePerks.BAREFISTED_SMITHING,player)){
            player.animate(new Animation(2068));
            return;
        }
