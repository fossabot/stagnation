        ...
        when (`object`.id) {
            2231 -> if (player.location.x <= 2791) {
                ForceMovement.run(
                    player,
                    `object`.location,
                    `object`.location.transform(3, 0, 0),
                    SCALE,
                    SCALE,
                    Direction.WEST,
                    13
