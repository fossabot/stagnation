...
import content.global.skill.member.summoning.familiar.*;
import content.global.skill.member.summoning.familiar.dialogue.MacawDialogueFile;
	...
	public final class MacawDialogue extends DialoguePlugin {
		...
		public boolean handle(int interfaceId, int buttonId) {
			...
			case 0:
				switch (buttonId) {
				case 1:
					player.getDialogueInterpreter().open(new MacawDialogueFile());
					stage++;
					break;
				case 2:
					end();
