...
/**
 * Represents the Rune Minotaur familiar interaction dialogue.
 */
@Initializable
class RuneMinotaurDialogue(player: Player? = null) : DialoguePlugin(player) {

    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        openDialogue(player, RuneMinotaurDialogueFile())
        return true
    }
