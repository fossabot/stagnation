...
public class Fletching {
    ...
    public enum String{
            ...
            String(byte indicator, final int unfinished, final int product, final int level, final double experience, final Animation animation) {
                ...
                switch(indicator & 0xFF){
                    case 1:
                        this.string = config.Items.BOW_STRING_1777;
                        break;
                    case 2:
                        this.string = config.Items.CROSSBOW_STRING_9438;
                        break;
                    default:
                        break;
                }
    ...
    public enum GemBolts {
        OPAL(877, config.Items.OPAL_1609, 45, 879, 11, 1.6),
        PEARL(9140, config.Items.OYSTER_PEARL_411, 46, 880, 41, 3.2),
        PEARLS(9140, config.Items.OYSTER_PEARLS_413, 46, 880, 41, 3.2),
        JADE(9139, config.Items.JADE_1611, 9187, 9335, 26, 2.4),
        RED_TOPAZ(9141, config.Items.RED_TOPAZ_1613, 9188, 9336, 48, 3.9),
        SAPPHIRE(9142, config.Items.SAPPHIRE_1607, 9189, 9337, 56, 4.7),
        EMERALD(9142, config.Items.EMERALD_1605, 9190, 9338, 58, 5.5),
        RUBY(9143, config.Items.RUBY_1603, 9191, 9339, 63, 6.3),
        DIAMOND(9143, config.Items.DIAMOND_1601, 9192, 9340, 65, 7),
        DRAGONSTONE(9144, config.Items.DRAGONSTONE_1615, 9193, 9341, 71, 8.2),
        ONYX(9144, config.Items.ONYX_6573, 9194, 9342, 73, 9.4);
