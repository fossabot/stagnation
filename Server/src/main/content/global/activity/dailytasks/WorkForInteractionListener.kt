...
import content.global.activity.dailytasks.impl.Employers
...
class WorkForInteractionListener : InteractionListener {
    override fun defineListeners() {
        on(
            ...
            IntType.NPC, "work-for") { player, node ->
            ...
            if (job != null && job.employer.npcId == node.id) {
                if (playerJobManager.jobAmount == 0) {
                    ...
                    sendNPCDialogue(player, job.employer.npcId, "There you go, thanks for your help. You're quite a skilled worker!")
                } else {
