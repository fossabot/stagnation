...
public final class EmoteCluePlugin extends EmoteClueScroll {
	...
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		...
		register(new EmoteCluePlugin("zammy-altar-shrug", 2713, ClueLevel.HARD, emote, new int[][] { { 1079 }, { 1115 }, { 2487 } }, "Shrug in the Zamorak temple<br>found in the<br>Eastern Wilderness.<br>Beware of double agents!<br>Equip rune plate legs,<br>an iron plate body and<br>blue dragonhide<br>vambraces.", new ZoneBorders(3233, 3603, 3246, 3614)));
		emote = Emotes.SPIN;
