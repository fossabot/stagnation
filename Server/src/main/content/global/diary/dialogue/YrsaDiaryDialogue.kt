...
/**
 * Represents the conversation with Yrsa about achievements.
 */
class YrsaDiaryDialogue : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        npc = NPC(NPCs.YRSA_1301)
        when (stage) {
            0 -> if(player!!.achievementDiaryManager.getDiary(DiaryType.FREMENNIK).isComplete(1, true) && !AchievementDiary.hasClaimedLevelRewards(player, DiaryType.FREMENNIK, 1)) {
