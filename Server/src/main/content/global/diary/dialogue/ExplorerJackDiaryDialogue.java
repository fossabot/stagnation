package content.global.diary.dialogue;
...
/**
 * Represents the Explorer Jack dialogue plugin.
 */
@Initializable
public class ExplorerJackDiaryDialogue extends DialoguePlugin {
	...
	public ExplorerJackDiaryDialogue() {}

	public ExplorerJackDiaryDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new ExplorerJackDiaryDialogue(player);
	}
