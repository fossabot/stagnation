...
/**
 * Represents the conversation with a Council Workman about achievements.
 */
        ...
        when (stage) {
            ...
            2 -> when (buttonID) {
                ...
                2 -> if (player!!.achievementDiaryManager.getDiary(DiaryType.FREMENNIK).isComplete(0, true) && !AchievementDiary.hasClaimedLevelRewards(player, DiaryType.FREMENNIK, 0)) {
                    player(FacialExpression.FRIENDLY, "About the Achievement Diary...").also { stage = 11 }
                    ...
                    player(FacialExpression.FRIENDLY, "About the Achievement Diary...").also { stage = 5 }
                }
            }
