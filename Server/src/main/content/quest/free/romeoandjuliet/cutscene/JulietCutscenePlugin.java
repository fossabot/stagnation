package content.quest.free.romeoandjuliet.cutscene;

import content.quest.free.romeoandjuliet.dialogue.JulietRJDialogue;
...
/**
 * Represents the cutscene plugin for Romeo And Juliet quest.
 */
@Initializable
public final class JulietCutscenePlugin extends CutscenePlugin {
	...
	public JulietCutscenePlugin() {
		this(null);
		ClassScanner.definePlugin(new JulietRJDialogue());
	}
