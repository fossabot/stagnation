package content.quest.free.romeoandjuliet;
...
public class RomeoAndJuliet extends Quest {
	...
	/**
	 * Constructs a new {@code RomeoAndJuliet} {@code Object}.
     */
	public RomeoAndJuliet() {
		super("Romeo & Juliet", 26, 25, 5, Vars.VARP_QUEST_ROMEO_JULIET_144, 0, 1, 100);
	}
