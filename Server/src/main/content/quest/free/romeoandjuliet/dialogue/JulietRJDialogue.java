package content.quest.free.romeoandjuliet.dialogue;

import content.quest.free.romeoandjuliet.cutscene.JulietCutscenePlugin;
...
/**
 * Represents the Juliet dialogue plugin.
 */
public final class JulietRJDialogue extends DialoguePlugin {
	 ...
	 */
	public JulietRJDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new JulietRJDialogue(player);
	}
