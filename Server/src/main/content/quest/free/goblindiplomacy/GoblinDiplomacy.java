package content.quest.free.goblindiplomacy;

import config.Vars;
import content.quest.free.goblindiplomacy.cutscene.GDiplomacyCutscene;
import content.quest.free.goblindiplomacy.dialogue.GrubfootDialogue;
import content.quest.free.goblindiplomacy.plugin.GoblinDiplomacyPlugin;
...
/**
 * Represents the Goblin Diplomacy quest.
 */
@Initializable
public class GoblinDiplomacy extends Quest {
	...
	public int[] getConfig(Player player, int stage) {
		if (stage == 0) {
			return new int[] {Vars.VARP_QUEST_GOBLIN_DIPLOMACY_62, 0 };
		}
		if (stage == 10) {
			return new int[] { Vars.VARP_QUEST_GOBLIN_DIPLOMACY_62, 1 };
		} else if (stage == 20) {
			return new int[] { Vars.VARP_QUEST_GOBLIN_DIPLOMACY_62, 4 };
		} else if (stage == 30) {
			return new int[] { Vars.VARP_QUEST_GOBLIN_DIPLOMACY_62, 5 };
		} else if (stage == 100) {
			return new int[] { Vars.VARP_QUEST_GOBLIN_DIPLOMACY_62, 6 };
		}
		return new int[] { Vars.VARP_QUEST_GOBLIN_DIPLOMACY_62, 0 };
	}
