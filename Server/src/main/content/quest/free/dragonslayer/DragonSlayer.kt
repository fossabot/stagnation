package content.quest.free.dragonslayer

import config.Items
import config.Vars
import content.global.skill.member.agility.AgilityHandler
import content.quest.free.dragonslayer.cutscene.DragonSlayerCutscene
import content.quest.free.dragonslayer.dialogue.*
import content.quest.free.dragonslayer.npc.*
import content.quest.free.dragonslayer.plugin.CrandorMapPlugin
import content.quest.free.dragonslayer.plugin.DSMagicDoorPlugin
import content.quest.free.dragonslayer.plugin.DragonSlayerPlugin
import content.region.misthalin.draynor.dialogue.NedDialogue
 ...
 */
@Initializable
class DragonSlayer : Quest("Dragon Slayer", 18, 17, 2, Vars.VARP_QUEST_DRAGON_SLAYER_176, 0, 1, 10), LoginListener {
