...
/**
 * Represents Oziach dialogue plugin for the Dragon Slayer quest.
 */
public final class OziachDSDialogue extends DialoguePlugin {
	...
	/**
	 * Constructs a new {@code OziachDSDialogue} {@code Object}.
	 */
	public OziachDSDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public OziachDSDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new OziachDSDialogue(player);
	}
