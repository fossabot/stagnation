...
/**
 * Represents Wormbrain dialogue plugin for the Dragon Slayer quest.
 */
public final class WormbrainDSDialogue extends DialoguePlugin {
	...
	/**
	 * Constructs a new {@code WormbrainDSDialogue} {@code Object}.
	 */
	public WormbrainDSDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public WormbrainDSDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new WormbrainDSDialogue(player);
	}
