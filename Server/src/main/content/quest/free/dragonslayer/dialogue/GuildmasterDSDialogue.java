...
/**
 * Represents the Guildmaster dialogue plugin for the Dragon Slayer quest.
 */
public final class GuildmasterDSDialogue extends DialoguePlugin {
	 ...
	 */
	public GuildmasterDSDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new GuildmasterDSDialogue(player);
	}
