package content.quest.free.dragonslayer.dialogue;
...
/**
 * Represents the Cabin Boy Jenkins dialogue plugin used for the Dragon Slayer quest.
 */
@Initializable
public class CabinBoyJenkinsDSDialogue extends DialoguePlugin {
	...
	/**
	 * Constructs a new {@code CabinBoyJenkinsDialogue} {@code Object}.
	 */
	public CabinBoyJenkinsDSDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public CabinBoyJenkinsDSDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new CabinBoyJenkinsDSDialogue(player);
	}
