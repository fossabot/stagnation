package content.quest.free.piratestreasure;

import config.Vars;
import content.quest.free.piratestreasure.plugin.PiratesTreasurePlugin;
...
public final class PiratesTreasure extends Quest {
	...
	public PiratesTreasure() {
		super("Pirate's Treasure", 23, 22, 2, Vars.VARP_QUEST_PIRATES_TREASURE_71, 0, 1, 4);
	}
