...
/**
 * Represents the Gillie Groats dialogue plugin for Cooks Assistant quest.
 */
@Initializable
class GillieGroatsCADialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return GillieGroatsCADialogue(player)
    }
