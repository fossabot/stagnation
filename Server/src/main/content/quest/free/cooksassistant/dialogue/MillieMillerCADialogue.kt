 ...
 /**
  * Represents the Millie Miller dialogue plugin for Cooks Assistant quest.
  */
 @Initializable
 class MillieMillerCADialogue(player: Player? = null) : DialoguePlugin(player) {
     ...
     override fun newInstance(player: Player?): DialoguePlugin {
         return MillieMillerCADialogue(player)
     }
