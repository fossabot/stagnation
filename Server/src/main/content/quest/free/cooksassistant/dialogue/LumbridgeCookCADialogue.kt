package content.quest.free.cooksassistant.dialogue
...
/**
 * Represents the Lumbridge Cook dialogue plugin for Cooks Assistant quest.
 */
@Initializable
class LumbridgeCookCADialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            100 ->
                ...
                } else if (!player.getAttribute("cooks_assistant:flour_submitted", false) && inInventory(player, FLOUR, 1)) {
                ...
                } else if (!player.getAttribute("cooks_assistant:egg_submitted", false) && inInventory(player, EGG, 1)) {
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return LumbridgeCookCADialogue(player)
    }
