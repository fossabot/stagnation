package content.quest.free.blackknightsfortress;

import config.Vars;
import content.quest.free.blackknightsfortress.dialogue.SirAmikVarzeBKFDialogue;
import content.quest.free.blackknightsfortress.plugin.BKCabbagePlugin;
import content.quest.free.blackknightsfortress.plugin.BKFortressPlugin;
...
public final class BlackKnightsFortress extends Quest {
	...
	public BlackKnightsFortress() {
		super("Black Knights' Fortress", 14, 13, 3, Vars.VARP_QUEST_BLACK_KNIGHTS_FORTRESS_130, 0, 1, 4);
	}
	
	@Override
	public Quest newInstance(Object object) {
		ClassScanner.definePlugins(new BKCabbagePlugin(), new BKFortressPlugin(), new SirAmikVarzeBKFDialogue());
		return this;
	}
