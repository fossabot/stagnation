package content.quest.free.princealirescue;

import config.Vars;
import content.quest.free.princealirescue.dialogue.LadyKeliPARDialogue;
import content.quest.free.princealirescue.npc.LadyKeliNPC;
import content.quest.free.princealirescue.plugin.PrinceAliRescuePlugin;
import content.quest.free.princealirescue.plugin.WigDyePlugin;
...
public class PrinceAliRescue extends Quest {
	...
	public PrinceAliRescue() {
		super("Prince Ali Rescue", 24, 23, 3, Vars.VARP_QUEST_PRINCE_ALI_RESCUE_273, 0, 1, 110);
	}

	@Override
	public Quest newInstance(Object object) {
		ClassScanner.definePlugins(new LadyKeliPARDialogue(), new LadyKeliNPC(), new PrinceAliRescuePlugin(), new WigDyePlugin());
		return this;
	}
