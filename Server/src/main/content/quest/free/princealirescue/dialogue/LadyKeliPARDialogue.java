package content.quest.free.princealirescue.dialogue;
...
/**
 * Represents the Lady Keli dialogue plugin for the Prince Ali Rescue quest.
 */
public final class LadyKeliPARDialogue extends DialoguePlugin {
	 ...
	 */
	public LadyKeliPARDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new LadyKeliPARDialogue(player);
	}
