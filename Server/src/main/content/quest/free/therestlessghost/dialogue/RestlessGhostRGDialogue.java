...
/**
 * Represents the Restless Ghost dialogue plugin for The Restless Ghost quest.
 */
@Initializable
public class RestlessGhostRGDialogue extends DialoguePlugin {

	public RestlessGhostRGDialogue() {

	}

	public RestlessGhostRGDialogue(Player player) {
		super(player);
	}
	...
	public DialoguePlugin newInstance(Player player) {
		...
		return new RestlessGhostRGDialogue(player);
	}
