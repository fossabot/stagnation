...
/**
 * Represents the Father Uhrney dialogue plugin for The Restless Ghost quest.
 */
@Initializable
public final class FatherUhrneyRGDialogue extends DialoguePlugin {

	/**
	 * Constructs a new {@code FatherUhrneyDialogue} {@code Object}.
	 */
	public FatherUhrneyRGDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public FatherUhrneyRGDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new FatherUhrneyRGDialogue(player);
	}
