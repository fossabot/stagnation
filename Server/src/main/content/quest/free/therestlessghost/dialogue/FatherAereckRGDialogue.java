package content.quest.free.therestlessghost.dialogue;
...
import static core.api.ContentAPIKt.openInterface;

/**
 * Represents the Father Aereck dialogue plugin for The Restless Ghost quest.
 */
@Initializable
public final class FatherAereckRGDialogue extends DialoguePlugin {

    /**
     * Constructs a new {@code FatherAereckDialogue} {@code Object}.
     */
    public FatherAereckRGDialogue() {
        /**
         * empty.
         */
    }
     ...
     */
    public FatherAereckRGDialogue(Player player) {
        super(player);
    }

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new FatherAereckRGDialogue(player);
    }
