package content.quest.free.therestlessghost;

import config.Vars;
import content.quest.member.animalmagnetism.dialogue.OldCronAMDialogue;
...
public class RestlessGhost extends Quest {
	...
	public RestlessGhost() {
		super(NAME, 25, 24, 1, Vars.VARP_QUEST_RESTLESS_GHOST_107, 0, 4, 5);
	}	

	@Override
	public Quest newInstance(Object object) {
		ClassScanner.definePlugin(new OldCronAMDialogue());
		return this;
	}
