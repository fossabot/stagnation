...
/**
 * Represents the Reldo dialogue plugin for Shield of Arrav quest.
 */
public class ReldoSOADialogue extends DialoguePlugin {
     ...
     */
    public ReldoSOADialogue(Player player) {
        super(player);
    }
    ...
    public DialoguePlugin newInstance(Player player) {
        return new ReldoSOADialogue(player);
    }
