...
/**
 * Represents the Straven dialogue plugin for Shield of Arrav quest.
 */
public class StravenSOADialogue extends DialoguePlugin {
	 ...
	 */
	public StravenSOADialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new StravenSOADialogue(player);
	}
