...
/**
 * Represents the King Roald dialogue plugin for Shield of Arrav quest.
 */
class KingRoaldSOADialogue : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        else if(player!!.getInventory().containsItem(ShieldofArrav.BLACKARM_CERTIFICATE) || player!!.getInventory().containsItem(
