package content.quest.free.shieldofarrav.dialogue;
...
/**
 * Represents the Weapons Master dialogue plugin for Shield of Arrav quest.
 */
public final class WeaponsMasterSOADialogue extends DialoguePlugin {
	 ...
	 */
	public WeaponsMasterSOADialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public WeaponsMasterSOADialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new WeaponsMasterSOADialogue(player);
	}
