...
/**
 * Represents Charlie The Tramp dialogue plugin for Shield of Arrav quest.
 */
@Initializable
class CharlieTheTrampSOADialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return CharlieTheTrampSOADialogue(player)
    }
