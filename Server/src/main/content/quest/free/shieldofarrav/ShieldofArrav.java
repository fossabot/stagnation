package content.quest.free.shieldofarrav;

import config.Vars;
import content.quest.free.shieldofarrav.dialogue.*;
import content.quest.free.shieldofarrav.npc.JohnnyBeardNPC;
import content.quest.free.shieldofarrav.plugin.CertificatePlugin;
import content.quest.free.shieldofarrav.plugin.JonnytheBeardPlugin;
import content.quest.free.shieldofarrav.plugin.ShieldArravPlugin;
...
public class ShieldofArrav extends Quest {
	...
	public ShieldofArrav() {
		super("Shield of Arrav", 29, 28, 1, Vars.VARP_QUEST_SHIELD_OF_ARRAV_145, 0, 1, 7);
	}

	@Override
	public Quest newInstance(Object object) {
		ClassScanner.definePlugins(new CertificatePlugin(), new CuratorHaigHalenDialogue(), new JohnnyBeardNPC(), new JonnytheBeardPlugin(), new KatrineSOADialogue(), new KingRoaldDialogue(), new ReldoSOADialogue(), new ShieldArravPlugin(), new StravenSOADialogue(), new WeaponsMasterSOADialogue());
		return this;
	}
