package content.quest.free.sheepshearer.dialogue

import config.Items
import content.quest.free.sheepshearer.SheepShearer
import core.api.*
...
/**
 * Handler Fred the farmer dialogue file for Sheep Hearer quest.
 */
