package content.quest.free.demonslayer;

import config.Vars;
import content.quest.free.demonslayer.cutscene.DemonSlayerCutscene;
import content.quest.free.demonslayer.cutscene.WallyCutscenePlugin;
import content.quest.free.demonslayer.dialogue.GypsyArisDSDialogue;
import content.quest.free.demonslayer.dialogue.SirPyrsinDSDialogue;
import content.quest.free.demonslayer.dialogue.TraibornDSDialogue;
import content.quest.free.demonslayer.plugin.DSlayerDrainPlugin;
import content.quest.free.demonslayer.plugin.DemonSlayerPlugin;
...
public class DemonSlayer extends Quest {
	 ...
	 */
	public DemonSlayer() {
		super("Demon Slayer", 16, 15, 3, Vars.VARP_QUEST_DEMON_SLAYER_222, 0, 1, 3);
	}
	
	@Override
	public Quest newInstance(Object object) {
		ClassScanner.definePlugins(new DemonSlayerPlugin(), new DSlayerDrainPlugin(), new DemonSlayerCutscene(), new WallyCutscenePlugin(), new GypsyArisDSDialogue(), new SirPyrsinDSDialogue(), new TraibornDSDialogue(), new CaptainRovinDialogue());
		return this;
	} 
