package content.quest.free.demonslayer.dialogue;

import content.quest.free.demonslayer.DemonSlayer;
...
/**
 * Represents the Gypsy Aris dialogue plugin for Demon Slayer quest.
 */
public final class GypsyArisDSDialogue extends DialoguePlugin {
	 ...
	 */
	public GypsyArisDSDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new GypsyArisDSDialogue(player);
	}
