...
/**
 * Represents the Traiborn dialogue plugin for Demon Slayer quest.
 */
public class TraibornDSDialogue extends DialoguePlugin {
	 ...
	 */
	public TraibornDSDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new TraibornDSDialogue(player);
	}
