...
/**
 * Represents the Sir Pyrsin dialogue plugin for Demon Slayer quest.
 */
public class SirPyrsinDSDialogue extends DialoguePlugin {
	 ...
	 */
	public SirPyrsinDSDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new SirPyrsinDSDialogue(player);
	}
