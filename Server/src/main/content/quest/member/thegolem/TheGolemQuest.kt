package content.quest.member.thegolem

import config.Items
import config.NPCs
import config.Vars
import content.quest.member.thegolem.dialogue.ClayGolemProgramDialogueFile
import content.quest.member.thegolem.dialogue.DISPLAY_CASE_TEXT
import content.quest.member.thegolem.dialogue.LETTER_LINES
import core.api.*
 ...
 */
@Initializable
class TheGolemQuest : Quest("The Golem", 70, 69, 1, Vars.VARBIT_QUEST_THE_GOLEM_346, 0, 1, 10) {
...
class TheGolemListeners : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(6363, IntType.SCENERY, "open") { player, node -> sendMessage(player, "The door doesn't open."); return@on true }
