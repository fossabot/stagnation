package content.quest.member.smokingkills
...
class SmokingKills : Quest("Smoking Kills", 153, 152, 1, Vars.VARBIT_QUEST_SMOKING_KILLS_4764, 0, 1, 250) {
    companion object {
        const val SmokingKills = "Smoking Kills"
    }
    ...
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if (stage >= 1) {
            ...
            line(player, "She has requested that I rescue her sister from the well in the centre of Pollniveach.", line++, true)
            ...
            line(player, "I must explore an ancient tomb, east of the Agility Pyramid, in order to talk to a spirit.", line++, true)
            line(player, "The spirit should enable me to survive combined assaults from banshees and smoke. Ali Cat suggested that I take my cat with me to help, but warned that the spirit's ghostly form will make conversation tricky.", line++, true)
            line(player, "I have entered the tomb and discovered it is more complex than I first thought.", line++, true)
            line(player, "I should seek out the spirit.", line++, true)
            line(player, "Catolax, the spirit, has taught me how to create masked earmuffs, which can fend off smoke.", line++, true)
            line(player, "I need to combine a pair of earmuffs and a slayer face mask in order to rescue Sumona's sister from the well in Pollniveach.", line++, true)
            line(player, "If the player owns a pair of masked earmuffs:", line++, true)
            line(player, "I have combined a pair of earmuffs and a Slayer face mask to create masked earmuffs.", line++, true)
        ...
        if (stage == 100) {
            line++
            line(player, "I have defeated the banshee mistress and some insectoid assassins in order to rescue Sumona's sister, Jesmona.", line++, true)
