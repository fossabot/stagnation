package content.quest.member.bigchompybirdhunting.handlers
...
/**
 * Dialogues for Chompy Bird quest.
 */
class ChompyDialoguesHandler(val quest: Quest) : DialogueFile() {
  ...
  private fun handleWaitingForChompyDialogue(player: Player?, buttonId: Int) {
    ...
    val rantzIngredient = getAttribute(player, BigChompyBirdHunting.ATTR_ING_RANTZ, -1)
