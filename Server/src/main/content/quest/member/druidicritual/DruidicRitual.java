package content.quest.member.druidicritual;
...
public class DruidicRitual extends Quest {
	...
	public DruidicRitual() {
		super("Druidic Ritual", 48, 47, 4, Vars.VARP_QUEST_DRUIDIC_RITUAL_80, 0, 3, 4);
	}
	...
	public void drawJournal(Player player, int stage) {
		...
		if (stage == 100) {
			...
			player.getPacketDispatch().sendString("<col=FF0000>QUEST COMPLETE!</col>", 275, 9+ 7);
		}
	}
