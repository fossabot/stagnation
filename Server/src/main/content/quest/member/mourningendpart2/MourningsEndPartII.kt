package content.quest.member.mourningendpart2
...
/**
 * Mourning's End Part II quest.
 */
@Initializable
class MourningsEndPartII : Quest("Mourning's End Part II", 92, 91, 2,Vars.VARBIT_QUEST_MOURNINGS_END_PART_II_1103,0,1,60) {
    companion object {
        const val MourningsEndPartI = "Mourning's End Part II"
    }
