...
/**
 * Represents the Thrantax dialogue plugin for Merlin Crystal quest.
 */
public class ThrantaxMCDialogue extends DialoguePlugin {

	public ThrantaxMCDialogue() {

	}

	public ThrantaxMCDialogue(Player player) {
		super(player);
	}
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 500:
			...
			player.unlock();
			NPC npc = getAttribute(player, "thrantax_npc", null);
			if (npc != null) {
				npc.attack(player);
			}
			removeAttribute(player, "thrantax_npc");
			end();
			break;
		case 1000:
			removeAttribute(player, "thrantax_npc");
	...
	public DialoguePlugin newInstance(Player player) {
		return new ThrantaxMCDialogue(player);
	}
