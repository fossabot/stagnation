...
/**
 * Represents the The Lady Of The Lake dialogue plugin for Merlin Crystal quest.
 */
class TheLadyOfTheLakeMCDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        stage = if (!player.hasItem(Item(35, 1))) {
            ...
            && inEquipment(player, 14631,1) && inEquipment(player, 35,1)){
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            166 -> if (inInventory(player, 995, 500)) {
            ...
            } else if (inInventory(player, 995, 500)) {
    ...
    override fun newInstance(player: Player): core.game.dialogue.DialoguePlugin {
        return TheLadyOfTheLakeMCDialogue(player)
    }
