...
/**
 * Represents the Candle Maker dialogue plugin for Merlin Crystal quest.
 */
public final class CandleMakerMCDialogue extends DialoguePlugin {

	public CandleMakerMCDialogue() {

	}

	public CandleMakerMCDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new CandleMakerMCDialogue(player);
	}
