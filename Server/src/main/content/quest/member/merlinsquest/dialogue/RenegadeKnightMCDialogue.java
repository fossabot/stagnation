...
/**
 * Represents the Renegade Knight dialogue plugin for Merlin Crystal quest.
 */
public class RenegadeKnightMCDialogue extends DialoguePlugin {
    public RenegadeKnightMCDialogue() {}
    public RenegadeKnightMCDialogue(Player player) {super(player);}

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new RenegadeKnightMCDialogue(player);
    }
