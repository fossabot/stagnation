...
/**
 * Represents the Sir Gawain dialogue plugin for Merlin Crystal quest.
 */
public final class SirGawainMCDialogue extends DialoguePlugin {

    public SirGawainMCDialogue() {

    }

    public SirGawainMCDialogue(Player player) {
        super(player);
    }
    ...
    public DialoguePlugin newInstance(Player player) {
        return new SirGawainMCDialogue(player);
    }
