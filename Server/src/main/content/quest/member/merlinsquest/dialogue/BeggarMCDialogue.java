...
/**
 * Represents the Beggar dialogue plugin for Merlin Crystal quest.
 */
public final class BeggarMCDialogue extends DialoguePlugin {

	public BeggarMCDialogue() {

	}

	public BeggarMCDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new BeggarMCDialogue(player);
	}
