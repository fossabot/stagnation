...
/**
 * Represents the Sir Kay dialogue plugin for Merlin Crystal quest.
 */
public final class SirKayMCDialogue extends DialoguePlugin {

    public SirKayMCDialogue() {

    }

    public SirKayMCDialogue(Player player) {
        super(player);
    }
    ...
    public DialoguePlugin newInstance(Player player) {
        return new SirKayMCDialogue(player);
    }
