...
/**
 * Represents the Sir Lucan dialogue plugin for Merlin Crystal quest.
 */
public class SirLucanMCDialogue extends DialoguePlugin {

	public SirLucanMCDialogue() {
		/*
		 * empty.
		 */
	}

	public SirLucanMCDialogue(Player player) {
		super(player);
	}
	...
	public DialoguePlugin newInstance(Player player) {
		return new SirLucanMCDialogue(player);
	}
