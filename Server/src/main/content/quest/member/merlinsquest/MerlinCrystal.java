...
import config.Vars;
import content.quest.member.merlinsquest.dialogue.*;
import content.quest.member.merlinsquest.npc.SirMordredNPC;
import content.quest.member.merlinsquest.plugin.CrateCutscenePlugin;
import content.quest.member.merlinsquest.plugin.MerlinCrystalOptionPlugin;
import content.quest.member.merlinsquest.plugin.MerlinCrystalPlugin;
...
public final class MerlinCrystal extends Quest {
	...
	public MerlinCrystal() {
		super("Merlin's Crystal", 87, 86, 6, Vars.VARP_QUEST_MERLIN_CRYSTAL_14, 0, 1, 7);
	}
	...
	public Quest newInstance(Object object) {
		ClassScanner.definePlugins(new CrateCutscenePlugin(),
				...
				new BeggarMCDialogue(),
				new CandleMakerMCDialogue(),
				new KingArthurMCDialogue(),
				new MerlinCrystalOptionPlugin(),
				new SirKayMCDialogue(),
				new SirLancelotMCDialogue(),
				new SirLucanMCDialogue(),
				new SirMordredNPC(),
				new SirPalomedesMCDialogue(),
				new SirGawainMCDialogue(),
				new TheLadyOfTheLakeMCDialogue(),
				new ThrantaxMCDialogue(),
				new RenegadeKnightMCDialogue());
		return this;
	}
