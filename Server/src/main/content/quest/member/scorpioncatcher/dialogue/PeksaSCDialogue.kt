...
/**
 * [content.region.misthalin.barbvillage.dialogue.PeksaDialogue]
 * Represents the Peksa dialogue used in Scorpion Catcher quest.
 */
class PeksaSCDialogue : DialogueFile() {
