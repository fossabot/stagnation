...
/**
 * [content.region.kandarin.seers.dialogue.SeerDialogue]
 * Represents Seers dialogue used in Scorpion Catcher quest.
 */
class SeersSCDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int){
        ...
        when {
            (questStage in 1..30 && !getAttribute(player!!, SCUtils.PROGRESS_SC_ATTR_1, false)) ->{
                when(stage){
                    0 -> if(getAttribute(player!!, SCUtils.SEER_MIRROR_ATTR, false)){
                    ...
                    5 -> npcl(FacialExpression.NEUTRAL, "Let me look into my looking glass.").also{
                        ...
                        SCUtils.seerLookingAtMirror(player!!)
                    ...
                    12 -> {
                        ...
                        removeAttribute(player!!, SCUtils.SEER_MIRROR_ATTR)
                        setQuestStage(player!!, "Scorpion Catcher", 35)
                    }
            ...
            (questStage == 35 && getAttribute(player!!, SCUtils.PROGRESS_SC_ATTR_1, false)) -> {
                when(stage){
                    ...
                    6 -> {
                        ...
                        setAttribute(player!!, SCUtils.NPCS_DIALOG_ATTR, true)
                    }
                }
            }
