package content.quest.member.thedarknessofhallowvale
...
/**
 * The Darkness of Hallowvale quest.
 */
@Initializable
class TheDarknessofHallowvale : Quest("Darkness of Hallowvale", 42, 41, 2, Vars.VARBIT_QUEST_THE_DARKNESS_OF_HALLOWVALE_2573, 0, 1, 320) {
    companion object {
        const val TheDarknessofHallowvale = "Darkness of Hallowvale"
    }
