package content.quest.member.junglepotion;

import config.Vars;
import content.global.skill.member.herblore.Herbs;
import content.quest.member.junglepotion.dialogue.TrufitusJPDialogue;
import content.quest.member.junglepotion.plugin.JunglePotionPlugin;
...
public final class JunglePotion extends Quest {
	 ...
	 */
	public JunglePotion() {
		super(NAME, 81, 80, 1, Vars.VARP_QUEST_JUNGLE_POTION_175, 0, 1, 12);
	}
	
	@Override
	public Quest newInstance(Object object) {
		ClassScanner.definePlugin(new TrufitusJPDialogue());
