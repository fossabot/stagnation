package content.quest.member.junglepotion.dialogue;

import content.quest.member.junglepotion.JunglePotion;
import content.quest.member.junglepotion.JunglePotion.JungleObjective;
...
/**
 * Represents the Trufitus dialogue plugin for Jungle Potion quest.
 */
public final class TrufitusJPDialogue extends DialoguePlugin {
    ...
    /**
     * Constructs a new {@code TrufitusJPDialogue} {@code Object}.
     */
    public TrufitusJPDialogue() {
        /**
         * empty.
         */
    }
     ...
     */
    public TrufitusJPDialogue(final Player player) {
        super(player);
    }

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new TrufitusJPDialogue(player);
    }
