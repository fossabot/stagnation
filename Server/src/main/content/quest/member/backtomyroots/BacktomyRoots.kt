package content.quest.member.backtomyroots
...
class BacktomyRoots : Quest("Back to my Roots", 143, 142, 1,Vars.VARBIT_QUEST_BACK_TO_MY_ROOTS_4055,0,1,65) {
    companion object {
        const val BacktomyRoots = "Back to my Roots"
    }
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if (stage == 0) {
            ...
            line(player, "!!A Fairy Tale Part 1 - Growing Pains.??", line++, isQuestComplete(player,"A Fairy Tale I - Growing Pains"))
            line++
        }
        if (stage == 1) {
            ...
            line(player, "I found out about Wizard Cromperty's special preservation magic - a sealed pot.", line++, false)
            ...
            line(player, "I agreed to grow the cutting for Horacio in the prepared patch at Handelmort Mansion.", line++, false)
