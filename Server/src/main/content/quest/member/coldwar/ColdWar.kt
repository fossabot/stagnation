package content.quest.member.coldwar
...
class ColdWar : Quest("Cold War", 132, 131, 1,Vars.VARBIT_QUEST_COLD_WAR_3293,0,1,135) {
    ...
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if (stage == 0) {
            ...
            line(player, if (hasLevelStat(player, Skills.AGILITY, 30)) "---Level 30 Agility/--" else "!!Level 30 Agility??", line++)
            line(player, if (hasLevelStat(player, Skills.CRAFTING, 30)) "---Level 30 Crafting/--" else "!!Level 30 Crafting??", line++)
            line(player, if (hasLevelStat(player, Skills.CONSTRUCTION, 34)) "---Level 34 Construction/--" else "!!Level 34 Construction??", line++)
            line(player, if (hasLevelStat(player, Skills.HUNTER, 10)) "---Level 10 Hunter/--" else "!!Level 10 Hunter??", line++)
            line++
        }
        if (stage == 1) {
