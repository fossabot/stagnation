package content.quest.member.spiritsoftheelid
 ...
 */
@Initializable
class SpiritsofTheElid : Quest("Spirits of the Elid", 116, 115, 2, Vars.VARBIT_QUEST_SPIRITS_OF_THE_ELID_1444, 0, 1, 60) {
    override fun newInstance(`object`: Any?): Quest {
        return this
    }

    companion object {
        const val SpiritsofTheElid = "Spirits of the Elid"
    }
