...
/**
 * Represents the dialogues file for Creature of Fenkenstrain quest.
 */
class SignpostDialogue : DialogueFile() {
    ...
    class DrFenkenstrainDialogue0 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
                ...
                4 -> playerl("Okay...").also { stage++ }
                5 -> npcl("How would you describe yourself in one word?").also { stage++ }
    ...
    class DrFenkenstrainDialogue1 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
                0 -> options(
                    "Do you know where I could find body parts?",
    ...
    class DrFenkenstrainDialogue2 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
                0 -> options(
                    "I have some body parts for you.",
                    "What do you want me to do again?",
                    "Why do you want to make a creature?",
                    "Will this creature put me out of a job?",
                    "I must get back to work, sir."
    ...
    class DrFenkenstrainDialogue3 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class DrFenkenstrainDialogue4 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class DrFenkenstrainDialogue5 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class DrFenkenstrainDialogue6 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class DrFenkenstrainDialogue7 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class DrFenkenstrainDialogue8 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class DrFenkenstrainDialogue9 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class DrFenkenstrainDialogue10 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
                0 -> npcl("So have you destroyed it?!?").also { stage++ }
    ...
    class DrFenkenstrainDialogue11 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class GardenerGhostDialogue0 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
                0 -> options(
                    "Can you tell me anything about Fenkenstrain?",
    ...
    class GardenerGhostDialogue1 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class GardenerGhostDialogue2 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class GardenerGhostDialogue3 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class GardenerGhostGraveDialogue4 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class GardenerGhostDialogue5 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class GardenerGhostDialogue6 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class RoavarDialogue0 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
                ...
                6 -> options("I'll buy one, please.", "I'm not very hungry.").also { stage++ }
                7 -> when (buttonID) {
                    1 -> playerl("I'll buy one, please.").also { stage = 8 }
                    2 -> playerl("I'm afraid I'm not really hungry at the moment.").also { stage = END_DIALOGUE }
                }
                8 -> npcl("A very wise choice. Don't eat it all at once, savour every morsel - that's my advice to you.").also { stage = END_DIALOGUE }
            }
        }
    }

    // Attempting to pick up the pickled brain in Canafis
    class RoavarDialogue1 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class FenkenstrainAmuletDialogue0 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class FenkenstrainAmuletDialogue1 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class FenkenstrainMonsterDialogue0 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when(stage) {
    ...
    class FenkenstrainMonsterDialogue1 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when (stage) {
    ...
    class FenkenstrainMonsterDialogue2 : DialogueFile() {
        override fun handle(componentID: Int, buttonID: Int) {
            when(stage) {
