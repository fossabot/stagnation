package content.quest.member.atailoftwocats
...
class ATailofTwoCats : Quest("A Tail of Two Cats", 119, 118, 2,Vars.VARBIT_QUEST_A_TAIL_OF_TWO_CATS_1028,0,1,70) {
    ...
    companion object {
        const val ATailofTwoCats = "A Tail of Two Cats"
    }
    ...
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if (stage == 0) {
            ...
            line(player, "!!Completed Icthlarin's Little Helper quest.??", line++, isQuestComplete(player,"Icthlarin's Little Helper"))
