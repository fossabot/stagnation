 ...
 */
@Initializable
class EW2 : Quest("Elemental Workshop II", 53, 52, 1,Vars.VARBIT_QUEST_EW_II_2639,0,1,11) {
    companion object { const val questName = "Elemental Workshop II" }
    ...
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if (stage == 0) {
            ...
            if (isQuestComplete(player,"Elemental Workshop I")) {
                line(player, "<str>Elemental Workshop I</str>", line++, false)
                line++
            } else {
    ...
    override fun finish(player: Player?) {
        ...
        setVarbit(player, Vars.VARBIT_QUEST_EW_II_2639, 11, true)
