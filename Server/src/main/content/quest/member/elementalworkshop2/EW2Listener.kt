package content.quest.member.elementalworkshop2
...
/**
 * Listeners for the Elemental Workshop II quest.
 */
class EW2Listener : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(Items.SPELL_SCROLL_2396, IntType.ITEM, "read") { player, _ ->
            ...
            setQuestStage(player, EW2.questName, 3)
            return@on true
        }
        ...
        on(Scenery.BOOKCASE_17382, IntType.SCENERY, "search") { player, _ ->
            if (isQuestComplete(player, "Elemental Workshop I")
                ...
                setQuestStage(player, EW2.questName, 1)
        ...
        on(Scenery.MACHINERY_18594, IntType.SCENERY, "search") { player, _ ->
            ...
            setQuestStage(player, EW2.questName, 4)
        ...
        onUseWith(IntType.SCENERY, Items.KEY_9722, Scenery.HATCH_18595) { player, _, _ ->
            ...
            setQuestStage(player, EW2.questName, 5)
            ...
            override fun handle(componentID: Int, buttonID: Int) {
                when (stage) {
                    0 -> sendDialogueOptions(
                        player!!, "There are two schematics here...",
                        "Crane schematic", "Lever schematic"
                    ).also { stage++ }
                    ...
                    1 -> when (buttonID) {
                        ...
                        2 -> {
                            ...
                            sendItemDialogue(
                                player!!,
                                EW2Utils.LeverSchematic,
                                "You take a copy of the schematic drawing."
                            )
        ...
        on(EW2Utils.JunctionBox, IntType.SCENERY, "open") { player, _ ->
            ...
            setAttribute(player, "ew2:progress", 0)
            return@on true
        }
        ...
        on(EW2Utils.CartLever, IntType.SCENERY, "pull") { player, npc ->
            lock(player, 5)
            animate(player, EW2Utils.PullLever)
            player.dialogueInterpreter.sendDialogue(
