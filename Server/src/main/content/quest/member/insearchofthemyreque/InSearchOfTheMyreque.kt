package content.quest.member.insearchofthemyreque
 ...
 */
@Initializable
class InSearchOfTheMyreque : Quest("In Search of the Myreque", 80, 79, 2, Vars.VARP_QUEST_IN_SEARCH_OF_MYREQUE_387, 0, 1, 101) {
    companion object {
    ...
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if (stage == 0) {
            ...
            if (player.properties.combatLevel >= 100) {
                line(player, "<str><col=000000>I also need to be able to defeat a level 97 foe.</col></str>", line++, false)
            } else {
