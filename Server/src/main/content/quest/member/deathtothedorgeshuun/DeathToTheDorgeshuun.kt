package content.quest.member.deathtothedorgeshuun
 ...
 */
@Initializable
class DeathToTheDorgeshuun : Quest("Death to the Dorgeshuun", 43, 42, 1,Vars.VARBIT_QUEST_DEATH_TO_DORGESHUUN_2258,0,1,13) {
    ...
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if (stage >= 0) {
            ...
            line(player, if (hasLevelStat(player, Skills.THIEVING, 23)) "---Level 23 Thieving./--" else "!!Level 23 Thieving.??", line++)
            line(player, if (hasLevelStat(player, Skills.AGILITY, 23)) "---Level 23 Agility./--" else "!!Level 23 Agility.??", line++)
