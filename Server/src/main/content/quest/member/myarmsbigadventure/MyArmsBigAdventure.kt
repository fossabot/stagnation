package content.quest.member.myarmsbigadventure
 ...
 */
@Initializable
class MyArmsBigAdventure : Quest("My Arm's Big Adventure", 94, 93, 1,Vars.VARBIT_QUEST_MY_ARMS_BIG_ADVENTURE_2790,0,1,311) {
    companion object {
        const val MyArmsBigAdventure = "My Arm's Big Adventure"
    }
