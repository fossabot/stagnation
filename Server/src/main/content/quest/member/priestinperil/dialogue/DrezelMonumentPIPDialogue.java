package content.quest.member.priestinperil.dialogue;
...
/**
 * Represents the Drezel Monument dialogue plugin.
 */
@Initializable
public final class DrezelMonumentPIPDialogue extends DialoguePlugin {
	 ...
	 */
	public DrezelMonumentPIPDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public DrezelMonumentPIPDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new DrezelMonumentPIPDialogue(player);
	}
