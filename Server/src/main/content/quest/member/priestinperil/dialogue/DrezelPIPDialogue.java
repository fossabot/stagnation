...
/**
 * Represents the Drezel dialogue plugin.
 */
@Initializable
public final class DrezelPIPDialogue extends DialoguePlugin {
	 ...
	 */
	public DrezelPIPDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new DrezelPIPDialogue(player);
	}
