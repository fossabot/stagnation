package content.quest.member.landofthegoblin
 ...
 */
@Initializable
class LandOfTheGoblins : Quest("Land of the Goblins", 144, 143, 1,Vars.VARBIT_QUEST_LAND_OF_THE_GOBLIN_4105,0,1,18) {
    companion object {
        const val LandOfTheGoblins = "Land of the Goblins"
    }
