...
/**
 * Represents first experiment cutscene in Enlightened Journey quest.
 */
class FirstExperimentCutscene(player: Player) : Cutscene(player) {
    ...
    override fun runStage(stage: Int) {
        when (stage) {
            ...
            12 -> {
                dialogueUpdate(NPCs.AUGUSTE_5049, FacialExpression.HAPPY, "We shall meekly go! No...no...it needs to sound grander. We shall cautiously go...")
            }
