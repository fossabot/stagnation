package content.quest.member.elementalworkshop
...
import content.quest.member.elementalworkshop.util.EWUtils.BELLOWS_STATE
import content.quest.member.elementalworkshop.util.EWUtils.FURNACE_STATE
import content.quest.member.elementalworkshop.util.EWUtils.LEFT_WATER_CONTROL_STATE
import content.quest.member.elementalworkshop.util.EWUtils.RIGHT_WATER_CONTROL_STATE
import content.quest.member.elementalworkshop.util.EWUtils.WATER_WHEEL_STATE
import content.quest.member.elementalworkshop.util.EWUtils.currentStage
import core.api.*
