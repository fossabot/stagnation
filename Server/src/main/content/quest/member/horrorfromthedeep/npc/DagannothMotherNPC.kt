...
/**
 * Handles Dagannoth Mother NPC for Horror from the deep quest.
 */
class DagannothMotherNPC constructor(id: Int = 0, location: Location? = null, session: DagannothSession? = null) : AbstractNPC(id, location) {
    ...
    override fun finalizeDeath(killer: Entity?) {
        ...
        if (killer is Player) {
            ...
            if(!inInventory(killer, HFTDUtils.QUEST_CASKET)){
                addItemOrDrop(killer, HFTDUtils.QUEST_CASKET)
            }
