...
import config.NPCs
import content.quest.member.horrorfromthedeep.npc.DagonnothBabyNPC.Companion.spawnDagannothBaby
...
/**
 * Represents the Jossik dialogue file for Horror from the Deep quest.
 */
class JossikHFTDUndergroundDialogue : DialogueFile() {
        ...
        when (getQuestStage(player!!, "Horror from the Deep")) {
            ...
            55 -> when (stage) {
                ...
                9 -> {
                    ...
                    spawnDagannothBaby(player!!)
                    setQuestStage(player!!, "Horror from the Deep", 56)
                }
            }
            ...
            60 -> when (stage) {
                ...
                4 -> {
                    ...
                    setQuestStage(player!!, "Horror from the Deep", 61)
                }
            }
            ...
            // Talk After killing the Daggonoth Mother.
            100 -> when (stage) {
