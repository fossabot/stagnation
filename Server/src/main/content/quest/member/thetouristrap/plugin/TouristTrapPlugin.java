package content.quest.member.thetouristrap.plugin;
...
import content.quest.member.thetouristrap.plugin.TouristTrapPlugin.AnnaCartHandler.AnnaCartCutscene;
import content.quest.member.thetouristrap.plugin.TouristTrapPlugin.BedabinAnvilHandler.AnnaWinchHandler;
...
public final class TouristTrapPlugin extends OptionHandler {
        ...
        switch (option) {
            ...
            case "open":
                switch (id) {
                    ...
                    case 2690:
                    case 2691:
                        setAttribute(player, "ana-delay", GameWorld.getTicks() + 2);
            ...
            case "inspect":
                if (id == 18875) {
                    player.getDialogueInterpreter().sendDialogue("You remember that Irena mentioned something about Ana wearing a red scarf before she left for the desert.");
                }
                break;
            case "climb-down":
                if (id == 18924) {
    ...
    public static final class AnnaCartHandler extends UseWithHandler {
        ...
        public boolean handle(final NodeUsageEvent event) {
            ...
            setAttribute(player, "ana-delay", GameWorld.getTicks() + 100000000);
        ...
        public static final class MiningCartCutscene extends CutscenePlugin {
            ...
            public void open() {
                ...
                GameWorld.getPulser().submit(new Pulse(22, player) {
                    @Override
                    public boolean pulse() {
                        setAttribute(player, "real-end", index == 0 ? Location.create(3319, 9431, 0) : Location.create(3303, 9416, 0));
                        setAttribute(player, "cutscene:original-loc", index == 0 ? Location.create(3319, 9431, 0) : Location.create(3303, 9416, 0));
