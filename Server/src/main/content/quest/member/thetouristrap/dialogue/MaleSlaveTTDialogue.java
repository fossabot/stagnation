...
/**
 * Represents the Male Slave dialogue plugin for the Tourist Trap quest.
 */
public final class MaleSlaveTTDialogue extends DialoguePlugin {
	 ...
	 */
	public MaleSlaveTTDialogue(final Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new MaleSlaveTTDialogue(player);
	}
