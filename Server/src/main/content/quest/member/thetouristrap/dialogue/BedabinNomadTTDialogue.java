...
/**
 * Represents the Bedabin Nomad dialogue plugin for the Tourist Trap quest.
 */
public final class BedabinNomadTTDialogue extends DialoguePlugin {
	...
	/**
	 * Constructs a new {@code BedabinNomadTTDialogue} {@code Object}.
	 */
	public BedabinNomadTTDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public BedabinNomadTTDialogue(final Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new BedabinNomadTTDialogue(player);
	}
