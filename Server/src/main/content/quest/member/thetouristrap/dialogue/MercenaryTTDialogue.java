...
/**
 * Represents the mercenary dialogue plugin for the Tourist Trap quest.
 */
public final class MercenaryTTDialogue extends DialoguePlugin {
	 ...
	 */
	public MercenaryTTDialogue(final Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new MercenaryTTDialogue(player);
	}
