...
/**
 * Represents the Minecart Driver dialogue plugin for the Tourist Trap quest.
 */
public final class MinecartDriverTTDialogue extends DialoguePlugin {
	 ...
	 */
	public MinecartDriverTTDialogue(final Player player) {
		super(player);
	}
	 ...
	 * Constructs a new {@code MinecartDriverDialogue} {@code Object}.
	 */
	public MinecartDriverTTDialogue() {
		/**
		 * empty.
		 */
	}
	...
	public DialoguePlugin newInstance(Player player) {
		return new MinecartDriverTTDialogue(player);
	}
