...
/**
 * Represents the Ana dialogue plugin for the Tourist Trap quest.
 */
public final class AnaTTDialogue extends DialoguePlugin {
	 ...
	 */
	public AnaTTDialogue(final Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new AnaTTDialogue(player);
	}
