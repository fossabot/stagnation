...
/**
 * Represents the Captain Siad dialogue plugin for the Tourist Trap quest.
 */
public final class CaptainSiadTTDialogue extends DialoguePlugin {
	 ...
	 */
	public CaptainSiadTTDialogue(final Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new CaptainSiadTTDialogue(player);
	}
