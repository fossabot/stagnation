package content.quest.member.thetouristrap.dialogue;

import content.quest.member.thetouristrap.TouristTrap;
...
/**
 * Represents the Irena dialogue plugin for the Tourist Trap quest.
 */
public final class IrenaTTDialogue extends DialoguePlugin {
	 ...
	 */
	public IrenaTTDialogue(final Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new IrenaTTDialogue(player);
	}
	...
	public boolean open(Object... args) {
		...
		switch (quest.getStage(player)) {
			...
			case 99:
				...
				npc(FacialExpression.FRIENDLY,"Thanks so much for returning my daughter to me.", "I expect that she will go on another trip soon though.", "She is the adventurous type... a bit like yourself really!", "Okay, see you around then!");
				break;
			default:
				npc(FacialExpression.HALF_CRYING,"*Sob* Have you found my daughter yet?");
				break;
		}
		return true;
	}
			...
			case 0:
				switch (stage) {
					...
					case 7:
						...
						break;
					case 8:
						npc(FacialExpression.HALF_CRYING,"And I'm sure that Ana will also be very pleased! And I", "may see if I can get a small reward together... But I", "cannot promise anything. So does that mean that you'll", "look for her then?");
						stage++;
						break;
					case 9:
					...
					case 10:
						...
						break;
					case 11:
						npc(FacialExpression.HALF_ASKING,"Are you 'really' sure you want to do this? I mean, go", "on this quest?");
						stage++;
						break;
					case 12:
					...
					case 14:
						...
						break;
					case 15:
						npc(FacialExpression.NEUTRAL,"I did go looking for her myself and I came across some", "footprints just a little way south. I'm worried that they", "lead to the desert mining camp.");
						stage++;
						break;
					case 16:
						quest.start(player);
