...
/**
 * Represents the Mercenary Captain dialogue plugin for the Tourist Trap quest.
 */
public final class MercenaryCaptainTTDialogue extends DialoguePlugin {
	 ...
	 */
	public MercenaryCaptainTTDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public MercenaryCaptainTTDialogue(final Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new MercenaryCaptainTTDialogue(player);
	}
