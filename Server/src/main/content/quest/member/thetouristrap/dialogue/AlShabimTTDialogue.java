...
/**
 * Represents the Al Shabim dialogue plugin for the Tourist Trap quest.
 */
public final class AlShabimTTDialogue extends DialoguePlugin {
	...
	/**
	 * Constructs a new {@code AlShabimTTDialogue} {@code Object}.
	 */
	public AlShabimTTDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public AlShabimTTDialogue(final Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new AlShabimTTDialogue(player);
	}
