...
/**
 * Represents the Desert Guard dialogue plugin for the Tourist Trap quest.
 */
public final class DesertGuardTTDialogue extends DialoguePlugin {
	 ...
	 */
	public DesertGuardTTDialogue(final Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new DesertGuardTTDialogue(player);
	}
