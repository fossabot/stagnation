package content.quest.member.thetouristrap;

import config.Items;
import config.Vars;
import content.quest.member.thetouristrap.dialogue.*;
import content.quest.member.thetouristrap.npc.MineSlaveNPC;
import content.quest.member.thetouristrap.npc.RowdySlaveNPC;
import content.quest.member.thetouristrap.plugin.TouristTrapPlugin;
import content.quest.member.thetouristrap.zone.MiningCampZone;
...
public final class TouristTrap extends Quest {
     ...
     */
	public TouristTrap() {
		super(NAME, 123, 122, 2, Vars.VARP_QUEST_TOURIST_TRAP_197, 0, 1, 30);
	}
	
	@Override
	public Quest newInstance(Object object) {
		ClassScanner.definePlugins(new TouristTrapPlugin(), new AnaTTDialogue(), new CaptainSiadTTDialogue(), new DesertGuardTTDialogue(), new IrenaTTDialogue(), new MaleSlaveTTDialogue(), new MercenaryCaptainTTDialogue(), new MercenaryTTDialogue(), new MinecartDriverTTDialogue(), new MineSlaveNPC(), new MiningCampZone(), new RowdySlaveNPC(), new AlShabimTTDialogue(), new BedabinNomadTTDialogue());
		return this;
	}
