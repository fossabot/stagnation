package content.quest.member.deserttreasure.dialogue
...
/**
 * Represents Archaeologist dialogue for "Desert treasure quest".
 */
@Initializable
class ArchaeologistDTDialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return ArchaeologistDTDialogue(player)
    }
