...
/**
 * Represents "The History of the Outpost" book for Making History quest.
 */
@Initializable
class OutpostHistory : InteractionListener {
    companion object {
        ...
        private val CONTENTS = arrayOf(
            ...
            PageSet(
                ...
                Page(
                    BookLine("(although not in power, we suspect).", 66),
                    BookLine("", 67),
    ...
    override fun defineListeners() {
        on(MakingHistoryListener.largeDisplay, IntType.SCENERY, "study") { player, _ ->
