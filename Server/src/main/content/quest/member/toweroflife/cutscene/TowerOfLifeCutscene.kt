package content.quest.member.toweroflife.cutscene
...
/**
 * Handles cutscene for Tower of life quest.
 */
class TowerOfLifeCutscene(player: Player) : Cutscene(player) {
    ...
    override fun runStage(stage: Int) {
        when (stage) {
            ...
            42 -> playerDialogueUpdate(FacialExpression.FRIENDLY, "They've run away. I must go confront those alchemists downstairs.")
            43 -> setAttribute(player, QUEST_CUTSCENE, true)
        }
    }
