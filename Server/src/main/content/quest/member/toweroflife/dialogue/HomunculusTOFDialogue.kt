...
/**
 * Represents the Homunculus dialogue plugin for Tower of Life quest.
 */
@Initializable
class HomunculusTOFDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (getQuestStage(player!!, "Tower Of Life")) {
            7 -> when(stage) {
                ...
                4 -> playerl(FacialExpression.FRIENDLY, "No, honest. I helped the alchemists, but I had no idea what their plans involved.").also { stage++ }
                5 -> npcl(FacialExpression.FRIENDLY, "Arggh, so alchemist create me now I trapped for experiements. But still I confused.").also { stage++ }
                ...
                10 -> npcl(FacialExpression.FRIENDLY, "No so sure it is easy to do. No one canna 'elp. Arghhh.").also { stage++ }
                11 -> playerl(FacialExpression.FRIENDLY, "Watch me.").also { stage++ }
                12 -> npcl(FacialExpression.FRIENDLY, "You must now make sense of the Homunculus's mind. Force him to either follow the line of logic or the line of magic.").also { stage++ }
                13 -> playerl(FacialExpression.FRIENDLY, "You tell me that you're confused, so ask me some questions!").also { stage++ }
                ...
                18 -> when(buttonID) {
                    ...
                    2 -> playerl(FacialExpression.FRIENDLY, "With the help of the magical dragonstones!").also { stage++ }
                    3 -> playerl(FacialExpression.FRIENDLY, "By ignition of gas in their belly as they exhale.").also { stage++ }
                }
                ...
                20 -> when(buttonID) {
                    1 -> playerl(FacialExpression.FRIENDLY, "Runecraft, enchant jewellery, perform alchemy.").also { stage++ }
                ...
                22 -> when(buttonID) {
                    ...
                    2 -> playerl(FacialExpression.FRIENDLY, "I'd like to think you wouldn't be carrying bones around.").also { stage++ }
                ...
                24 -> when(buttonID) {
                    1 -> playerl(FacialExpression.FRIENDLY, "I'm not really much of a traveller, sorry.").also { stage++ }
                    2 -> playerl(FacialExpression.FRIENDLY, "Run, run as fast as you can.").also { stage++ }
                    3 -> playerl(FacialExpression.FRIENDLY, "Depends where you are headed, but teleport spells are a safe bet.").also { stage++ }
                }
                ...
                26 -> when(buttonID) {
                    1 -> playerl(FacialExpression.FRIENDLY, "Yes, you can make magic potions to boost your skills.").also { stage++ }
                    2 -> playerl(FacialExpression.FRIENDLY, "People mix together ingredients in vials. The nutrients will help you.").also { stage++ }
                ...
                28 -> when(buttonID) {
                    ...
                    3 -> playerl(FacialExpression.FRIENDLY, "Take a rune stone to an altar and use a talisman.").also { stage++ }
                }
                ...
                30 -> when(buttonID) {
                    1 -> playerl(FacialExpression.FRIENDLY, "Perhaps. I've never seen it myself, though.").also { stage++ }
                    2 -> playerl(FacialExpression.FRIENDLY, "Yep, you can use the Telekinetic Grab spell.").also { stage++ }
                    3 -> playerl(FacialExpression.FRIENDLY, "Sure. Use your brain to tell someone to move it!").also { stage++ }
                }
                ...
                32 -> when(buttonID) {
                    ...
                    3 -> playerl(FacialExpression.FRIENDLY, "It's a simple case of combining materials.").also { stage++ }
                }
                ...
                34 -> when(buttonID) {
                    1 -> playerl(FacialExpression.FRIENDLY, "You have special powers - no surprise seeing how you were created.").also { stage++ }
                    2 -> playerl(FacialExpression.FRIENDLY, "Coincidence - there is a lot of loose metal around.").also { stage++ }
                ...
                36 -> when(buttonID) {
                    ...
                    3 -> playerl(FacialExpression.FRIENDLY, "That's up to you; depends on what you find interesting.").also { stage++ }
                }
                ...
                38 -> when(buttonID) {
                    ...
                    3 -> playerl(FacialExpression.FRIENDLY, "Well the sun is not actually there, it's where it used to be!").also { stage++ }
                }
                ...
                40 -> when(buttonID) {
                    1 -> playerl(FacialExpression.FRIENDLY, "Everything has a reason, even if you don't know what it is.").also { stage++ }
                    2 -> playerl(FacialExpression.FRIENDLY, "Probably a bit of both.").also { stage++ }
                    3 -> playerl(FacialExpression.FRIENDLY, "Your very existence speaks of mystical forces.").also { stage++ }
                }
                ...
                45 -> npcl(FacialExpression.FRIENDLY, "No does matter which you chose. Me needed organise my thoughts. I see there is truth in both.").also { stage++ }
                46 -> playerl(FacialExpression.FRIENDLY, "Okay.").also { stage++ }
                47 -> npcl(FacialExpression.FRIENDLY, "Now we go scare alchemies - they have been wrong to do this. Although I have life, they mustn't go about this again.").also { stage++ }
                48 -> playerl(FacialExpression.FRIENDLY, "Sounds like a good plan. Can you get out of that cage?").also { stage++ }
                49 -> npcl(FacialExpression.FRIENDLY, "Easy. You run down and I watching from here. I surprise right moment.").also { stage++ }
            ...
            8 -> when(stage){
                ...
                1 -> npcl(FacialExpression.FRIENDLY, "Better. You been mine angel. I now have the understanding I need.").also { stage++ }
                2 -> playerl(FacialExpression.FRIENDLY, "My pleasure.").also { stage++ }
                3 -> npcl(FacialExpression.FRIENDLY, "Please, alchemists you speak, me appear to surprise.").also { stage++ }
                4 -> playerl(FacialExpression.FRIENDLY, "I'm not sure I understand, but okay, I will go have a word with them.").also { stage++ }
            ...
            9 -> when(stage){
                ...
                3 -> npcl(FacialExpression.FRIENDLY, "They use essence of Guthix power. Create tower pump this from ground. Make me with godly power. Dangerous.").also { stage++ }
                4 -> playerl(FacialExpression.FRIENDLY, "Oh dear, but you're okay now. You have this place to reside in.").also { stage++ }
                5 -> npcl(FacialExpression.FRIENDLY, "Thrank you. For reward you speak me, I makes monsters.").also { stage++ }
                6 -> {
                    end()
            ...
            100 -> when(stage){
                0 -> playerl(FacialExpression.FRIENDLY, "Hi there, you mentioned something about creating monsters...?").also { stage++ }
                1 -> npcl(FacialExpression.FRIENDLY, "Good! I gain know from alchemists and builders. Me make beings.").also { stage++ }
                2 -> playerl(FacialExpression.FRIENDLY, "Interesting. Tell me if I'm right. By the alchemists and builders creating you, you have inherited their combined knowledge in much the same way that a child might inherit the looks of their parents.").also { stage++ }
                ...
                5 -> npcl(FacialExpression.FRIENDLY, "Inspect symbol of life altars around dungeon. You see item give. Use item on altar. Activate altar to create, you fight.").also { stage++ }
