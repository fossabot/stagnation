...
/**
 * Represents the various 'object' dialogues in Tower of Life quest.
 * MachinesDialogues: PipeMachineDialogue, CageDialogue, TowerDialogue.
 */
class MachinesTOFDialogue : DialogueFile() {
