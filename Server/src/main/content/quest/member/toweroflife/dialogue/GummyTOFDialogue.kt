...
/**
 * Represents the Gummy dialogue plugin for Tower of Life quest.
 */
@Initializable
class GummyTOFDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (getQuestStage(player!!, "Tower Of Life")) {
            ...
            2 -> when(stage){
                ...
                4 -> playerl(FacialExpression.FRIENDLY, "Ah, come on. You know you want to give me free stuff.").also { stage++ }
                ...
                7 -> npcl(FacialExpression.FRIENDLY, "Okay, okay. The other day I was drying my clothes on a line down by the shore. A storm hit and some of my clothing went missing.").also { stage++ }
                8 -> playerl(FacialExpression.FRIENDLY, "Likely story. Sure you weren't skinny dipping?").also { stage++ }
                9 -> npcl(FacialExpression.FRIENDLY, "Just go look and leave me be! Search around the tower and you may find them.").also { stage = END_DIALOGUE }
            }
            3 -> if(getAttribute(player, TowerOfLifeListener.ENTER_TOL, 0) == 1) when(stage){
                ...
                1 -> npcl(FacialExpression.FRIENDLY, "It's a draw at the moment. First it was best of three, then it was best of five.").also { stage++ }
