...
/**
 * Represents the Ballista dialogue file used in Tree Gnome Village quest.
 */
class BallistaTGVDialogue : DialogueFile(){
        ...
        if(tracker1 && tracker2 && tracker3) {
            when(stage){
                ...
                1 -> {
                    ...
                    interpreter!!.sendOptions("Enter the x-coordinate of the stronghold", "0001","0002","0003","0004").also { stage++ }
                }
                2 -> {
