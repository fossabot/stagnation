package content.quest.member.treegnomevillage.dialogue.trackergnomes
...
/**
 * Represents the TrackerGnome 1 dialogue file used in Tree Gnome Village quest.
 */
class TrackerGnome1Dialogue : DialogueFile(){
