package content.quest.member.witchshouse.dialogue;
...
/**
 * Handles the boy dialogue for witchs house quest.
 */
@Initializable
public class BoyWHDialogue extends DialoguePlugin {

    private static final Item BALL = new Item(2407);

    public BoyWHDialogue() {
    }

    public BoyWHDialogue(Player player) {
        super(player);
    }

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new BoyWHDialogue(player);
    }
