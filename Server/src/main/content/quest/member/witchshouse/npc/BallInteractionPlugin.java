package content.quest.member.witchshouse.npc;

import content.minigame.magetrainingarea.TelekineticGrabSpell;
...
/**
 * Handles the ball interaction for witchs house quest.
 */
@Initializable
