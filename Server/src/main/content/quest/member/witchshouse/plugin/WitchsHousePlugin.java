package content.quest.member.witchshouse.plugin;

import content.quest.member.witchshouse.npc.MouseNPC;
...
/**
 * Handles the main interactions for Witchs house quest.
 */
@Initializable
