package content.quest.member.clocktower.dialogue

import content.quest.member.clocktower.ClockTower
...
/**
 * Represents the Brother Kojo dialogue file for Clock Tower quest.
 */
class BrotherKojoCTDialogueFile : DialogueFile() {
