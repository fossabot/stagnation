package content.quest.member.allfiredup
...
class AllFiredUp : Quest("All Fired Up", 157, 156, 1){
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if(stage == 0){
            ...
            line(player, "!!43 Firemaking??", line++, getStatLevel(player,Skills.FIREMAKING) >= 43)
            line(player, "!!Completion of Priest in Peril??", line++, isQuestComplete(player,"Priest in Peril"))
    ...
    override fun finish(player: Player?) {
        ...
        setVarbit(player, Vars.VARBIT_QUEST_ALL_FIREDUP_1283, 0)
    }
