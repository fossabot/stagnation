...
/**
 * Represents the Squire Fyre dialogue plugin for All Fired Up quest.
 */
@Initializable
class SquireFyreAFUDialogue(player: Player? = null) : DialoguePlugin(player){
    override fun newInstance(player: Player?): DialoguePlugin {
        return SquireFyreAFUDialogue(player)
    }
