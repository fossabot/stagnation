package content.quest.member.allfiredup.dialogue
...
/**
 * Represents the Blaze Sharp eye dialogue plugin for All Fired Up quest.
 */
@Initializable
class BlazeSharpeyeAFUDialogue(player: Player? = null) : DialoguePlugin(player) {
    override fun newInstance(player: Player?): DialoguePlugin {
        return BlazeSharpeyeAFUDialogue(player)
    }
