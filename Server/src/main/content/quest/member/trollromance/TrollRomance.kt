package content.quest.member.trollromance
...
class TrollRomance : Quest("Troll Romance", 127, 126, 2, Vars.VARP_QUEST_TROLL_ROMANCE_385, 0, 1, 45) {
    companion object {
        const val TrollRomance = "Troll Romance"
    }
    ...
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if(stage == 0){
            ...
            line(player, "!!Must have completed Troll Stronghold??", line++, isQuestComplete(player,"Troll Stronghold"))
            line(player, if (hasLevelStat(player, Skills.AGILITY, 28)) "---Level 28 Agility/--" else "!!Level 28 Agility??", line++)
