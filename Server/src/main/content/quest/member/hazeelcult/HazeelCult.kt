 ...
 */
@Initializable
class HazeelCult : Quest("Hazeel Cult", 74, 73, 1, Vars.VARP_QUEST_HAZEEL_CULT_223, 0, 1, 9) {

    companion object { const val questName = "Hazeel Cult" }
    override fun drawJournal(player: Player?, stage: Int) {
        var MAHJARRAT = getAttribute(player!!, HazeelCultListeners.MAHJARRAT, true)
        var CARNILLEAN = getAttribute(player!!, HazeelCultListeners.CARNILLEAN, true)
        ...
        if (stage >= 2 && MAHJARRAT && !CARNILLEAN) {
        ...
        if (stage >= 3 && MAHJARRAT&& !CARNILLEAN) {
        ...
        if (stage >= 5 && MAHJARRAT&& !CARNILLEAN) {
        ...
        if (stage == 100 && MAHJARRAT && !CARNILLEAN) {
        ...
        if (stage >= 2 && CARNILLEAN && !MAHJARRAT) {
        ...
        if (stage >= 3 && CARNILLEAN && !MAHJARRAT) {
        ...
        if (stage >= 4 && CARNILLEAN && !MAHJARRAT) {
        ...
        if (stage >= 5 && CARNILLEAN && !MAHJARRAT) {
        ...
        if (stage == 100 && CARNILLEAN && !MAHJARRAT) {
    ...
    override fun finish(player: Player?) {
        ...
        /*
        addItemOrDrop(player, Items.CARNILLEAN_ARMOUR_2405, 1)
        addItemOrDrop(player, Items.HAZEELS_MARK_2406, 1)
        */
        //removeAttributes(
        //    player,
