...
/**
 * Represents the Alomone dialogue plugin for Hazeel Cult quest.
 */
@Initializable
class AlomoneHCDialogue(player: Player? = null) : DialoguePlugin(player) {

    override fun open(vararg args: Any?): Boolean {
        npc = args[0] as NPC
        if (getQuestStage(player,HazeelCult.questName) >= 2) {
