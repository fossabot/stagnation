...
/**
 * Represents the Archaeological Expert extension dialogue file for The Dig Site quest.
 */
class AEDigsiteUsedOnDialogue(val it: Int) : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            0 -> when (itemUsed) {
                ...
                i.ceramicRemains -> player(FacialExpression.FRIENDLY, "I found some pottery pieces.").also {
                    stage = 270
                }
                i.beltBuckle -> player(FacialExpression.ASKING, "Have a look at this unusual item...").also {
                    stage = 280
                }
                ...
                i.stoneTablet -> player(FacialExpression.FRIENDLY, "Have a look at this.").also { stage = 320 }
                    ...
                    "I don't think that has any archaeological significance"
                ).also { stage = 99 }
            }
            ...
            272 -> npcl(
                FacialExpression.LAUGH,
                "No, no, silly. They were known for their skill with clay."
            ).also { stage = 99 }
            280 -> npcl(
                FacialExpression.THINKING,
            ...
            310 -> npcl(
                FacialExpression.LAUGH,
                "Why, it looks like a teddy bear to me. Perhaps someone's lucky mascot!"
            ).also { stage = 99 }
            320 -> npcl(
                FacialExpression.NEUTRAL,
                "I don't need another tablet! One is enough, thank you."
            ).also { stage = 99 }
