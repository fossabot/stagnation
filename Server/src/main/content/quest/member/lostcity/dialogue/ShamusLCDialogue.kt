package content.quest.member.lostcity.dialogue

import config.NPCs
import content.quest.member.lostcity.handlers.ShamusTreeListener
...
/**
 * Represents the Shamus dialogue plugin for Lost City Quest.
 */
@Initializable
class ShamusLCDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun newInstance(player: Player): DialoguePlugin {
        return ShamusLCDialogue(player)
    }
