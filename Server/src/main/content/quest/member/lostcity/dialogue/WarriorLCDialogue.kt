...
/**
 * Represents the Warrior dialogue plugin for Lost City Quest.
 */
@Initializable
class WarriorLCDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun newInstance(player: Player): DialoguePlugin {
        return WarriorLCDialogue(player)
    }
