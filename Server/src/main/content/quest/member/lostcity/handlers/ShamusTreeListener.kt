...
/**
 * The Shamus tree interaction listener for Lost City quest.
 */
@Initializable
class ShamusTreeListener : InteractionListener {
    ...
    private fun showShamus(player: Player) {
        ...
        sendNPCDialogue(player,
            NPCs.SHAMUS_654,"Hey! Yer big elephant! Don't go choppin' down me house, now!", FacialExpression.FURIOUS)
