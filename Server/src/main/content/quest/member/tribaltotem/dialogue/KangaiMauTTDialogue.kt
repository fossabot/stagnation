...
/**
 * Represents the Kangai Mau dialogue plugin used in Tribal totem quest.
 */
@Initializable
class KangaiMauTTDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return KangaiMauTTDialogue(player)
    }
