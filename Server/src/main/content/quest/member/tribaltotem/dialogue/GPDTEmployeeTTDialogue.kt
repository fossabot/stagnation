package content.quest.member.tribaltotem.dialogue
...
/**
 * Represents the GPDT Employee dialogue plugin used in Tribal totem quest.
 */
@Initializable
class GPDTEmployeeTTDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return GPDTEmployeeTTDialogue(player)
    }
