...
/**
 * Represents the Horacio dialogue plugin used in Tribal totem quest.
 */
@Initializable
class HoracioTTDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return HoracioTTDialogue(player)
    }
