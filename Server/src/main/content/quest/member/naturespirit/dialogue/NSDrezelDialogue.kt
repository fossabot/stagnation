...
import config.Items
import content.quest.member.naturespirit.BlessingPulse
...
/**
 * Represents the Drezel dialogue plugin for Nature Spirit quest.
 */
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        if(questStage <= 5){
            when(stage){
                ...
                1 -> when(buttonID){
                    1 -> playerl(FacialExpression.NEUTRAL, "Sorry, not interested.").also { stage =
                        END_DIALOGUE
                    }
                ...
                4 -> when(buttonID){
                    ...
                    5 -> playerl(FacialExpression.NEUTRAL, "Sorry, I don't think I can help.").also { stage =
                        END_DIALOGUE
                    }
                }
                ...
                12 -> when(buttonID){
                    ...
                    2 -> playerl(FacialExpression.NEUTRAL, "Sorry, I don't think I can help.").also { stage =
                        END_DIALOGUE
                    }
                }
                ...
                24 -> playerl(FacialExpression.FRIENDLY, "I'll do my very best, don't worry, if he's in there and he's still alive I'll definitely find him.").also { stage =
                    END_DIALOGUE; player!!.questRepository.getQuest("Nature Spirit").start(player!!) }
            }
        }
            ...
            npcl(FacialExpression.NEUTRAL, "There you go my friend, you're now blessed. It's funny, now I look at you, there seems to be something of the faith about you. Anyway, good luck with your quest!").also { stage =
                END_DIALOGUE; player!!.questRepository.getQuest("Nature Spirit").setStage(player!!, 45) }
        }
