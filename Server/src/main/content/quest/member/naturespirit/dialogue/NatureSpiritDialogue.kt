...
/**
 * Represents the Nature Spirit dialogue plugin for Nature Spirit quest.
 */
@Initializable
class NatureSpiritDialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when(stage){
            ...
            202 -> npcl(FacialExpression.NEUTRAL, "You'll need this in order to collect together nature's bounty. It will bind the Ghast to you until you flee or it is defeated.").also { stage =
                END_DIALOGUE
            }
