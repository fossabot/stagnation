...
/**
 * Represents the Recruiter dialogue plugin used in Plague City quest.
 */
@Initializable
class RecruiterPCDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return RecruiterPCDialogue(player)
    }
