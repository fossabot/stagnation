...
/**
 * Represents the Civilian dialogue plugin used in Plague City quest.
 */
@Initializable
class CivilianPCDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return CivilianPCDialogue(player)
    }
