...
/**
 * Handles Bravek dialogue for Plague City quest.
 */
@Initializable
class BravekPCDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (getQuestStage(player!!, PlagueCity.PlagueCityQuest)) {
            ...
            14 -> when (stage) {
                1 -> if(removeItem(player!!, Items.HANGOVER_CURE_1504) || player.getAttribute("/save:elena:cure", false) == true) {
