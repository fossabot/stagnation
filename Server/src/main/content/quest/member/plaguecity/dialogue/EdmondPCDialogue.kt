...
import content.quest.member.plaguecity.PlagueCityListeners
import content.quest.member.plaguecity.cutscene.UndergroundCutscene
import core.api.*
...
/**
 * Represents the Edmond dialogue plugin used in Plague City quest.
 */
@Initializable
class EdmondPCDialogue(player: Player? = null) : DialoguePlugin(player) {
