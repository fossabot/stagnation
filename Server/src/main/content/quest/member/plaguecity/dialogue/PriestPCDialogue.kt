...
/**
 * Represents the Priest dialogue plugin in the Plague City area.
 */
@Initializable
class PriestPCDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return PriestPCDialogue(player)
    }
