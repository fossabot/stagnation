...
/**
 * Represents the Carla dialogue plugin used in Plague City quest.
 */
@Initializable
class CarlaPCDialogue(player: Player? = null) : DialoguePlugin(player) {
