package content.quest.member.familycrest.dialogue

import config.Items
import content.quest.member.familycrest.util.SwapGauntletsHelper
...
/**
 * Represents the Johnathon dialogue plugin for Family crest quest.
 */
@Initializable
class JohnathonFamilyCrestDialogue(player: Player? = null): DialoguePlugin(player)  {
    val CREST_PIECE: Item = Item(781)
    override fun newInstance(player: Player?): DialoguePlugin {
        return JohnathonFamilyCrestDialogue(player)
    }
