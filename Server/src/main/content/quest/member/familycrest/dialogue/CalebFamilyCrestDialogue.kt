...
/**
 * Represents the Caleb dialogue plugin for Family crest quest.
 */
@Initializable
class CalebFamilyCrestDialogue(player: Player? = null): DialoguePlugin(player) {

    val CREST_PIECE: Item = Item(780)

    override fun newInstance(player: Player?): DialoguePlugin {
        return CalebFamilyCrestDialogue(player)
    }
