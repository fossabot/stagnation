...
/**
 * Represents the Dimintheis dialogue plugin for Family crest quest.
 */
@Initializable
class DimintheisFamilyCrestDialogue(player: Player? = null): DialoguePlugin(player) {
    override fun newInstance(player: Player?): DialoguePlugin {
        return DimintheisFamilyCrestDialogue(player)
    }
