...
/**
 * Represents the Boot dialogue plugin for Family crest quest.
 */
@Initializable
class BootFamilyCrestDialogue (player: Player? = null): DialoguePlugin(player){
    override fun newInstance(player: Player?): DialoguePlugin {
        return BootFamilyCrestDialogue(player)
    }
