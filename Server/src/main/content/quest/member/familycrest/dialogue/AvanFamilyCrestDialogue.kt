...
/**
 * Represents the Avan dialogue plugin for Family crest quest.
 */
@Initializable
class AvanFamilyCrestDialogue (player: Player? = null): DialoguePlugin(player) {

    val CREST_PIECE_AVAN: Item = Item(779)

    override fun newInstance(player: Player?): DialoguePlugin {
        return AvanFamilyCrestDialogue(player);
    }
