package content.quest.member.sheepherder;

import config.Items;
import config.Vars;
import content.quest.member.sheepherder.npc.HerderSheepNPC;
...
public class SheepHerder extends Quest {
    ...
    public SheepHerder(){super("Sheep Herder",113,112,4, Vars.VARP_QUEST_SHEEP_HERDER_60,0,1,3);}
    ...
    public void finish(Player player) {
        ...
        removeAttribute(player, "sheep_herder:red_dead");
        removeAttribute(player, "sheep_herder:blue_dead");
        removeAttribute(player, "sheep_herder:green_dead");
        removeAttribute(player, "sheep_herder:yellow_dead");
        removeAttribute(player, "sheep_herder:all_dead");
