...
/**
 * Handles Orbon dialogue for sheep herder quest.
 */
@Initializable
public class OrbonSHDialogue extends DialoguePlugin {
    public OrbonSHDialogue(){
        //empty
    }
    public OrbonSHDialogue(Player player){super(player);}


    @Override
    public DialoguePlugin newInstance(Player player) {
        return new OrbonSHDialogue(player);
    }
