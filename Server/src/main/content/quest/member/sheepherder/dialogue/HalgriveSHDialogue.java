package content.quest.member.sheepherder.dialogue;
...
/**
 * Handles Halgrive dialogue for sheep herder quest.
 */
@Initializable
public class HalgriveSHDialogue extends DialoguePlugin {
    public HalgriveSHDialogue(){
        //empty
    }

    public HalgriveSHDialogue(Player player){super(player);}

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new HalgriveSHDialogue(player);
    }
