...
/**
 * Represents the grandpa Jack dialogue plugin for Fishing Contest quest.
 */
@Initializable
public final class grandpaJackFCDialogue extends DialoguePlugin {
     ...
     * @param player
     */
    public grandpaJackFCDialogue(final Player player) {
        super(player);
    }
    ...
    public DialoguePlugin newInstance(Player player) {
        return new grandpaJackFCDialogue(player);
    }
