...
/**
 * Represents the Dwarf dialogue plugin for Fishing Contest quest.
 */
@Initializable
public class DwarfFCDialogue extends DialoguePlugin {
    public DwarfFCDialogue(){
        //empty
    }
    public DwarfFCDialogue(Player player){super(player);}

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new DwarfFCDialogue(player);
    }
