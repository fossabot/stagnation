...
/**
 * Represents the Big Dave dialogue plugin for Fishing Contest quest.
 */
@Initializable
public class BigDaveFCDialogue extends DialoguePlugin {

    public BigDaveFCDialogue(){
        //empty
    }

    public BigDaveFCDialogue(Player player){super(player);}

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new BigDaveFCDialogue(player);
    }
