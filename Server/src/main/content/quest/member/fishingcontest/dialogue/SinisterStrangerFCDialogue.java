...
/**
 * Represents the Sinister Stranger dialogue plugin for Fishing Contest quest.
 */
@Initializable
public class SinisterStrangerFCDialogue extends DialoguePlugin {

	public SinisterStrangerFCDialogue() {

	}

	public SinisterStrangerFCDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) { return new SinisterStrangerFCDialogue(player);	}
