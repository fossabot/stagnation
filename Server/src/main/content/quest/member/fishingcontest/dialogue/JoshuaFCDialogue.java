...
/**
 * Represents the Joshua dialogue plugin for Fishing Contest quest.
 */
@Initializable
public class JoshuaFCDialogue extends DialoguePlugin {

    public JoshuaFCDialogue() {
        //empty
    }

    public JoshuaFCDialogue(Player player){super(player);}

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new JoshuaFCDialogue(player);
    }
