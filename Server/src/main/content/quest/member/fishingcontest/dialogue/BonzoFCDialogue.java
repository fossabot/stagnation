...
/**
 * Represents the Bonzo dialogue plugin for Fishing Contest quest.
 */
@Initializable
public final class BonzoFCDialogue extends DialoguePlugin {

    /**
     * Constructs a new {@code BonzoFCDialogue} {@code Object}.
     */
    public BonzoFCDialogue() {
        /**
         * empty.
         */
    }
     ...
     * @param player
     */
    public BonzoFCDialogue(Player player) {
        super(player);
    }
    ...
    public DialoguePlugin newInstance(Player player) {
        ...
        return new BonzoFCDialogue(player);
    }
