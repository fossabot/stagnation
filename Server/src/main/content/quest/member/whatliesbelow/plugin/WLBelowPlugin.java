package content.quest.member.whatliesbelow.plugin;

import config.Items;
import content.data.skill.SkillingTool;
import content.global.skill.free.runecrafting.Altar;
import content.quest.member.whatliesbelow.WhatLiesBelow;
import content.quest.member.whatliesbelow.cutscene.WLBelowCutscene;
import content.quest.member.whatliesbelow.dialogue.AnnaJonesWLBDialogue;
import content.quest.member.whatliesbelow.dialogue.RatBurgissWLBDialogue;
import content.quest.member.whatliesbelow.dialogue.SurokMagisWLBDialogue;
import content.quest.member.whatliesbelow.npc.KingRoaldNPC;
import content.quest.member.whatliesbelow.npc.OutlawNPC;
...
public class WLBelowPlugin extends OptionHandler {
	...
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		...
		ClassScanner.definePlugin(new AnnaJonesWLBDialogue());
		ClassScanner.definePlugin(new SurokMagisWLBDialogue());
		ClassScanner.definePlugin(new RatBurgissWLBDialogue());
