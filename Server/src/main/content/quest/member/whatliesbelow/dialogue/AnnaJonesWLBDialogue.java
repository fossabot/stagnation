...
/**
 * Handles the Anna Jones dialogue for WhatLiesBelow quest.
 */
public class AnnaJonesWLBDialogue extends DialoguePlugin {
	 ...
	 */
	public AnnaJonesWLBDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new AnnaJonesWLBDialogue(player);
	}
