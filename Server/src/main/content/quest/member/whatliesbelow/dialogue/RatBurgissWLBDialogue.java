package content.quest.member.whatliesbelow.dialogue;

import content.global.diary.dialogue.RatBurgissDiaryDialogue;
...
/**
 * The Rat Burgiss dialogue for WhatLiesBelow quest.
 */
public class RatBurgissWLBDialogue extends DialoguePlugin {
    /**
     * The quest.
     */
    private Quest quest;
    ...
    /**
     * Constructs a new {@Code RatBurgissWLBDialogue} {@Code Object}
     *
     * @param player the player.
     */
    public RatBurgissWLBDialogue(Player player) {
        super(player);
    }
    ...
    public DialoguePlugin newInstance(Player player) {
        return new RatBurgissWLBDialogue(player);
    }
