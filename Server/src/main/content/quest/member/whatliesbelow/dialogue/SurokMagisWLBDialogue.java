...
/**
 * Handles the Surok Magis dialogue for WhatLiesBelow quest.
 */
public class SurokMagisWLBDialogue extends DialoguePlugin {
	 ...
	 */
	public SurokMagisWLBDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new SurokMagisWLBDialogue(player);
	}
