...
/**
 * Represents the Lalli dialogue for Fremennik trials quest.
 */
@Initializable
class LalliFTDialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            ...
            7 -> when(buttonId){
                ...
                11 -> player("I see... okay, well, bye!").also { setAttribute(player, "/save:fremtrials:lalli-talkedto",true); stage = 1000 }
            ...
            56 -> interpreter.sendDialogue("You have a cunning plan to trick this troll. You need your pet rock,", "a cabbage, a potato and an onion.").also { removeAttribute(player, "fremtrials:fremtrials:lalli-talkedto");stage = 1000 }
