...
/**
 * Represents the Swensen The Navigator dialogue for Fremennik trials quest.
 */
@Initializable
class SwensenTheNavigatorFTDialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            ...
            13 -> {player("Oh really? Watch and learn...");stage = 1000;setAttribute(player,"/save:fremtrials:swensen-accepted",true)}
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return SwensenTheNavigatorFTDialogue(player)
    }
