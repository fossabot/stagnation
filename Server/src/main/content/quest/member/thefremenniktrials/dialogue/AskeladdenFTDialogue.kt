...
/**
 * Represents the Askeladden dialogue for Fremennik trials quest.
 */
@Initializable
class AskeladdenFTDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return AskeladdenFTDialogue(player)
    }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            41 -> playerl(FacialExpression.HAPPY,"My Fremennik name is ${getAttribute(player,"fremennikname","lebron james")}.").also { stage++ }
    ...
    override fun getIds(): IntArray {
        return intArrayOf(NPCs.ASKELADDEN_2439)
    }
