...
/**
 * Represents the Thorvald dialogue for Fremennik trials quest.
 */
@Initializable
class ThorvalFTdDialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return ThorvalFTdDialogue(player)
    }
