...
/**
 * Represents the Peer The Seer dialogue for Fremennik trials quest.
 */
@Initializable
class PeerTheSeerFTDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            ...
            153 -> npcl(FacialExpression.HAPPY,"Greetings to you, brother ${getAttribute(player,"fremennikname","dingle")}! What brings you to see me again?").also { stage++ }
            ...
            202 -> npcl(FacialExpression.HAPPY,"Of course, ${getAttribute(player,"fremennikname","dingle")}. I am always happy to aid those who have earned the right to wear Fremennik sea boots.").also {
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return PeerTheSeerFTDialogue(player)
    }
