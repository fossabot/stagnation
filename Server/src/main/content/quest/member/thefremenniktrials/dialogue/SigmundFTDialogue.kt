...
/**
 * Represents the Sigmund dialogue for Fremennik trials quest.
 */
@Initializable
class SigmundFTDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        else if(getAttribute(player,"sigmundreturning",false) && !anyInInventory(player, *QUEST_ITEMS)){
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return SigmundFTDialogue(player)
    }
