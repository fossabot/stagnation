...
/**
 * Represents the Sigli The Huntsman dialogue for Fremennik trials quest.
 */
@Initializable
class SigliTheHuntsmanFTDialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            ...
            23 -> npc("Take care of the talisman, and see me when you have","completed this task.").also{stage = 1000; setAttribute(player,"/save:fremtrials:sigli-accepted",true)}
            ...
            180 -> npcl(FacialExpression.HAPPY,"Hello again to you ${getAttribute(player,"fremennikname","spinky")}. How goes the hunt?").also { stage++ }
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return SigliTheHuntsmanFTDialogue(player)
    }
