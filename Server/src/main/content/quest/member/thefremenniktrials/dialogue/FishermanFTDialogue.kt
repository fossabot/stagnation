...
/**
 * Represents the Fisherman dialogue for Fremennik trials quest.
 */
@Initializable
class FishermanFTDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return FishermanFTDialogue(player)
    }

    override fun getIds(): IntArray {
        return intArrayOf(NPCs.FISHERMAN_1302)
    }
}