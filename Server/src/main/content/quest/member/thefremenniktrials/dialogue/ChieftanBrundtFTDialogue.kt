...
/**
 * Represents the Chieftan Brundt dialogue for Fremennik trials quest.
 */
@Initializable
class ChieftanBrundtFTDialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            ...
            321 -> {npc("If you can gain the support of seven of the twelve, then","you will be accepted as one of us without question.");stage = 1000; startQuest(player,"Fremennik Trials")}
            ...
            560 -> npcl(FacialExpression.HAPPY,"From this day onward, you are outerlander no more! In honour of your acceptance into the Fremennik, you gain a new name: ${getAttribute(player,"fremennikname","how did u break this")}.").also {
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return ChieftanBrundtFTDialogue(player)
    }
