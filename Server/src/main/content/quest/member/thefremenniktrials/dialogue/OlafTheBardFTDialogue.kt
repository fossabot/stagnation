...
/**
 * Represents the Olaf The Bard dialogue for Fremennik trials quest.
 */
@Initializable
class OlafTheBardFTDialogue(player: Player? = null) : DialoguePlugin(player){
    override fun open(vararg args: Any?): Boolean {
        if(inInventory(player, Items.STURDY_BOOTS_3700,1)){
            ...
            npcl(FacialExpression.HAPPY,"Hello again to you, ${getAttribute(player,"fremennikname","schlonko")}. Us bards should stick together, what can I do for you?")
            stage = 98
            return true
        }
    ...
    override fun newInstance(player: Player?): DialoguePlugin {
        return OlafTheBardFTDialogue(player)
    }
