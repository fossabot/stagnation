package content.quest.member.inaidofthemyreque
...
/**
 * In Aid Of The Myreque quest.
 */
@Initializable
class InAidOfTheMyreque : Quest("In Aid of the Myreque", 79, 78, 2,Vars.VARBIT_QUEST_IN_AID_OF_THE_MYREQUE_1990,0,1,421) {
    companion object {
        const val InAidOfTheMyreque = "In Aid of the Myreque"
    }
