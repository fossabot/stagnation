 ...
 */
class BrotherOmadMFDialogue : DialogueFile() {
        ...
        when (questStage) {
            ...
            10 -> {
                when(stage) {
                    ...
                    32 -> npcl(FacialExpression.SAD, "*yawn*..I'm off to bed! Farewell brave traveller!").also{player!!.inventory.remove(Item(
                        Items.CHILDS_BLANKET_90))
