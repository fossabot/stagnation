package content.quest.member.asafirstresort
...
class AsaFirstResort : Quest("As a First Resort", 147, 146, 1) {
    companion object {
        const val AsaFirstResort = "As a First Resort"
    }
    ...
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if (stage == 1) {
            ...
            line(player, "I have offered to help Chief Tess by talking to the human lady in the bank at Oo'glog.", line++, false)
            line++
