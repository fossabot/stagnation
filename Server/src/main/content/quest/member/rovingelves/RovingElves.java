package content.quest.member.rovingelves;

import config.Vars;
import content.quest.member.rovingelves.dialogue.ElunedREDialogue;
import content.quest.member.rovingelves.dialogue.IslwynREDialogue;
import content.quest.member.rovingelves.npc.MossGiantGuardianNPC;
import content.quest.member.rovingelves.plugin.RovingElvesObstacles;
import content.quest.member.rovingelves.plugin.RovingElvesPlugin;
...
public class RovingElves extends Quest {
     ...
     */
	public RovingElves() {
		super("Roving Elves", 105, 104, 1, Vars.VARP_QUEST_ROVING_ELVES_402, 0, 1, 6);
	}
	...
	public Quest newInstance(Object object) {
		...
		ClassScanner.definePlugin(new ElunedREDialogue());
		ClassScanner.definePlugin(new IslwynREDialogue());
