...
/**
 * Represents the Eluned dialogue plugin.
 */
public class ElunedREDialogue extends DialoguePlugin {

	public ElunedREDialogue() {

	}

	public ElunedREDialogue(Player player) {
		super(player);
	}
	...
	public DialoguePlugin newInstance(Player player) {
		return new ElunedREDialogue(player);
	}
