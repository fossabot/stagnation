package content.quest.member.rovingelves.dialogue;

import content.quest.member.rovingelves.RovingElves;
...
/**
 * Represents the Islwyn dialogue plugin.
 */
public class IslwynREDialogue extends DialoguePlugin {

	public IslwynREDialogue() {

	}

	public IslwynREDialogue(Player player) {
		super(player);
	}
	...
	public DialoguePlugin newInstance(Player player) {
		return new IslwynREDialogue(player);
	}
