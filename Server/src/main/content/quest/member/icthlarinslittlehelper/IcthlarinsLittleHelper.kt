package content.quest.member.icthlarinslittlehelper
...
/**
 * Icthlarins Little Helper quest.
 */
@Initializable
class IcthlarinsLittleHelper : Quest("Icthlarin's Little Helper", 78, 77, 2,Vars.VARBIT_QUEST_ICTHLARINS_LITTLE_HELPER_418,0,1,26) {
    companion object { const val IcthlarinsLittleHelper = "Icthlarin's Little Helper" }
