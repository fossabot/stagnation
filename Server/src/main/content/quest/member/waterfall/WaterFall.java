...
import config.Vars;
import content.quest.member.waterfall.dialogue.*;
import content.quest.member.waterfall.plugin.WaterfallPlugin;
...
public class WaterFall extends Quest {
     ...
     */
	public WaterFall() {
		super("Waterfall", 65, 64, 1, Vars.VARP_QUEST_WATERFALL_65, 0, 1, 10);
	}
	...
	public Quest newInstance(Object object) {
		ClassScanner.definePlugins(new AlmeraWFDialogue(), new GolrieWFDialogue(), new HadleyWFDialogue(), new HudonWFDialogue(), new WaterfallPlugin(), new WaterfallTreeDialogue());
		return this;
	}
