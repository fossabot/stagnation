package content.quest.member.waterfall.plugin;

import content.global.skill.member.agility.AgilityHandler;
import content.quest.member.waterfall.WaterFall;
...
public final class WaterfallPlugin extends OptionHandler {
	...
	public class WaterfallUseWithHandler extends UseWithHandler {
		...
		public boolean handle(NodeUsageEvent event) {
			...
			if (useditem.getId() == PEBBLE.getId() && object.getId() == 1992 && ItemDefinition.canEnterEntrana(player) && !player.getFamiliarManager().hasFamiliar()) {
