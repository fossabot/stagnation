...
import config.Items
import config.Items.KHALI_BREW_77
import config.Items.KHAZARD_CELL_KEYS_76
import config.NPCs
...
/**
 * Represents the Lazy guard dialogue file for Fight arena quest.
 */
class LazyGuardFADialogue : DialogueFile() {
