...
/**
 * Represents the Khazard Barman dialogue plugin.
 */
@Initializable
class KhazardBarmanFADialogue(player: Player? = null) : DialoguePlugin(player) {
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        if (getQuestStage(player!!, FightArena.FightArenaQuest) in 50..100) {
            when (stage) {
