...
import config.NPCs
import content.quest.member.fightarena.FightArena.Companion.FightArenaQuest
...
/**
 * Represents the Lady Servil dialogue plugin for Fight Arena.
 */
@Initializable
class LadyServilFADialogue(player: Player? = null) : DialoguePlugin(player) {
