...
import content.quest.member.fightarena.cutscenes.JailCutscene
import content.quest.member.fightarena.cutscenes.ThirdFightCutscene
import core.api.*
...
/**
 * Represents the General Khazard dialogue file for Fight arena quest.
 */
class GenKhazardFADialogue : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        npc = NPC(NPCs.GENERAL_KHAZARD_258)
        when (getQuestStage(player!!, content.quest.member.fightarena.FightArena.FightArenaQuest)) {
            ...
            91 -> when (stage) {
                ...
                5 -> {
                    ...
                    setQuestStage(player!!, content.quest.member.fightarena.FightArena.FightArenaQuest, 97)
