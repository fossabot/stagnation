...
/**
 * Represents the Jeremy Servil B dialogue in fight arena quest.
 */
@Initializable
class JeremyServilBDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun getIds(): IntArray {
        return intArrayOf(NPCs.JEREMY_SERVIL_266)
    }
}