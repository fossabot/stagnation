...
import content.quest.member.fightarena.cutscenes.SecondFightCutscene
import core.api.*
...
/**
 * Represents the Hengrad from Cell in fight arena quest.
 */
@Initializable
class HengradFADialogue : DialogueFile() {
        ...
        when (getQuestStage(player!!, FightArena.FightArenaQuest)) {
            ...
            in 72..87 -> when (stage) {
                ...
                10 -> {
                    ...
                    setQuestStage(player!!, content.quest.member.fightarena.FightArena.FightArenaQuest, 88)
                }
            }
