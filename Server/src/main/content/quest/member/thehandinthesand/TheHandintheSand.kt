package content.quest.member.thehandinthesand
 ...
 */
@Initializable
class TheHandintheSand : Quest("The Hand in the Sand", 72, 71, 1, Vars.VARBIT_QUEST_THE_HAND_IN_THE_SAND_1527, 0, 1, 160) {
    companion object {
        const val TheHandintheSand = "The Hand in the Sand"
    }
