package content.quest.member.catapultconstruction
 ...
 */
@Initializable
class CatapultConstruction : Quest("Catapult Construction", 148, 147, 2,Vars.VARBIT_QUEST_CATAPULT_CONSTRUCTION_4396,0,1,60) {
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if (stage == 0) {
            ...
            line(player, if (hasLevelStat(player, Skills.CONSTRUCTION, 44)) "---Level 44 Construction/--" else "!!Level 44 Construction??", line++)
            line(player, if (hasLevelStat(player, Skills.FLETCHING, 42)) "---Level 42 Fletching/--" else "!!Level 42 Fletching??", line++)
            line(player, if (hasLevelStat(player, Skills.SMITHING, 54)) "---Level 54 Smithing may be an advantage/--" else "!!Level 54 Smithing may be an advantage??", line++)
            line++
        }
        if (stage == 1) {
            line(player, "I can start this quest by talking to the Catapult Guard found north of the Tyras Camp.", line++, false)
            ...
            line(player, "The Catapult Guard forgot to treat the catapult and the wooden frame is rotten.", line++, false)
            line(player, "He's asked me to speak to General Hining in the Tyras Camp about repairing the catapult.", line++, false)
