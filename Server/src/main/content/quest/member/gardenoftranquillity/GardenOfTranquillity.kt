package content.quest.member.gardenoftranquillity
 ...
 */
@Initializable
class GardenOfTranquillity : Quest("Garden of Tranquility", 66, 65, 2,Vars.VARBIT_QUEST_GARDEN_OF_TRANQUILLITY_961,0,1,60) {
    companion object {
        const val GardenOfTranquillity = "Garden of Tranquility"
    }
