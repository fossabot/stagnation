package content.quest.member.thegrandtree.cutscene

import config.NPCs
import content.quest.member.thegrandtree.npc.BlackDemonNPC
...
/**
 * Represents Black demon cutscene in the Grand Tree quest.
 */
class BlackDemonCutscene(player: Player) : Cutscene(player) {
    ...
    override fun runStage(stage: Int) {
        when(stage)
        {
            ...
            6 -> {
                dialogueUpdate(NPCs.GLOUGH_671, FacialExpression.ANGRY, "You really are becoming a headache! Well, at least now you can die knowing you were right, it will save me having to hunt you down like all the other human filth of "+settings!!.name+"!")
            }
            7 -> {
