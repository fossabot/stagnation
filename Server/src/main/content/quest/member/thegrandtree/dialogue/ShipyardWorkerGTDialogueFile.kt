...
/**
 * Represents Shipyar dWorker dialogue file in the grand tree quest.
 */
@Initializable
class ShipyardWorkerGTDialogueFile : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        when (stage) {
            ...
            32 -> npcl("I'm not starting that again. Maybe if I ignore you you'll go away...").also {
                stage =
                    END_DIALOGUE
            }
