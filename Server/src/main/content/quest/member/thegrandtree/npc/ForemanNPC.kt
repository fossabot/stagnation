...
/**
 * Handles Foreman NPC in the grand tree quest.
 */
@Initializable
...
class ForemanDialogue: DialogueFile(){
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when(stage){
            ...
            41 -> npcl("True but if the gnomes are really going to take over "+settings!!.name+" they'll need at least that.").also { stage++ }
