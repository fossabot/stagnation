 ...
 */
@Initializable
class TheGrandTree: Quest("The Grand Tree", 71, 70, 5, Vars.VARP_QUEST_THE_GRAND_TREE_150, 0, 1, 160) {
    ...
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if(stage == 0) {
            ...
            line(player, if (player.properties.currentCombatLevel >= 99) "---High enough combat to defeat a level 172 demon./--" else "!!High enough combat to defeat a level 172 demon.??", line++)
            line++
        }
        if(stage >= 10){
