package content.quest.member.dwarfcannon.dmc
...
/**
 * Handles Dwarf multicannon manual.
 */
@Initializable
class DMCManual : InteractionListener {
    ...
    private fun display(player: Player, pageNum: Int, buttonID: Int): Boolean {
        BookInterface.pageSetup(player, BookInterface.FANCY_BOOK_3_49,
            content.quest.member.dwarfcannon.dmc.DMCManual.Companion.TITLE,
            content.quest.member.dwarfcannon.dmc.DMCManual.Companion.CONTENTS
        )
        return true
    }
