package content.quest.member.dwarfcannon;

import content.quest.member.dwarfcannon.dialogue.CaptainLawgofDCDialogue;
import content.quest.member.dwarfcannon.dialogue.LollkDCDialogue;
import content.quest.member.dwarfcannon.dialogue.NulodionDCDialogue;
import content.quest.member.dwarfcannon.npc.CaptainLawgofNPC;
import content.quest.member.dwarfcannon.plugin.DwarfCannonPlugin;
...
public class DwarfCannon extends Quest {
	...
	public Quest newInstance(Object object) {
		ClassScanner.definePlugin(new LollkDCDialogue());
		ClassScanner.definePlugin(new NulodionDCDialogue());
		ClassScanner.definePlugin(new CaptainLawgofNPC());
		ClassScanner.definePlugin(new CaptainLawgofDCDialogue());
