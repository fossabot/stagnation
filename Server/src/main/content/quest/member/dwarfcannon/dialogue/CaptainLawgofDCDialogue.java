...
/**
 * Represents the Captain Lawgof dialogue plugin used for Dwarf Cannon quest.
 */
public class CaptainLawgofDCDialogue extends DialoguePlugin {
	...
	/**
	 * Constructs a new {@Code CaptainLawgofDCDialogue} {@Code
	 * Object}
	 */
	public CaptainLawgofDCDialogue() {
		/**
		 * empty
		 */
	}
	 ...
	 */
	public CaptainLawgofDCDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new CaptainLawgofDCDialogue(player);
	}
