...
/**
 * Represents the Mary dialogue plugin for Murder Mystery quest.
 */
@Initializable
class MaryMMDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (getQuestStage(player!!, MurderMystery.MurderMystery)) {
            in 1..3 -> when (stage) {
                ...
                5 -> npcl(FacialExpression.HALF_CRYING, "I was with Hobbes and Louisa in the Kitchen helping to prepare Lord Sinclair's meal, and then when I took it to his study... I saw... oh, it was horrible... he was...").also { stage = 6 }
                ...
                7 -> npcl(FacialExpression.NEUTRAL, "I don't really remember hearing anything out of the ordinary.").also { stage = 8 }
                8 -> playerl(FacialExpression.ASKING, "No sounds of a struggle then?").also { stage = 9 }
                9 -> npcl(FacialExpression.NEUTRAL, "No, I don't remember hearing anything like that.").also { stage = 10 }
                10 -> playerl(FacialExpression.ASKING, "How about the guard dog barking?").also { stage = 11 }
                ...
                12 -> npcl(FacialExpression.HALF_WORRIED, "I overheard Anna saying to Stanford that if he didn't do something about the state of his compost heap, she was going to.").also { stage = 13 }
