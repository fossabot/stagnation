...
/**
 * Represents the Alice dialogue plugin for Animal Magnetism quest.
 */
public final class AliceAMDialogue extends DialoguePlugin {
	...
	/**
	 * Constructs a new {@code AliceAMDialogue} {@code Object}.
	 */
	public AliceAMDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public AliceAMDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new AliceAMDialogue(player);
	}
