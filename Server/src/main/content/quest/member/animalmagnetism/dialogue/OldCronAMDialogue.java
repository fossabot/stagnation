...
/**
 * Represents the Old Cron dialogue plugin for Animal Magnetism quest.
 */
public final class OldCronAMDialogue extends DialoguePlugin {
	...
	/**
	 * Constructs a new {@code OldCronAMDialogue} {@code Object}.
	 */
	public OldCronAMDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public OldCronAMDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new OldCronAMDialogue(player);
	}
