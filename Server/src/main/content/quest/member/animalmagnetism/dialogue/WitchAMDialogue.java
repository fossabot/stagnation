...
/**
 * Represents the Witch dialogue plugin for Animal Magnetism quest.
 */
public final class WitchAMDialogue extends DialoguePlugin {
	...
	/**
	 * Constructs a new {@code WitchAMDialogue} {@code Object}.
	 */
	public WitchAMDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public WitchAMDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new WitchAMDialogue(player);
	}
