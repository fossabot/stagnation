...
/**
 * Represents the Ava dialogue plugin for Animal Magnetism quest.
 */
public final class AvaAMDialogue extends DialoguePlugin {
	...
	/**
	 * Constructs a new {@code AvaAMDialogue} {@code Object}.
	 */
	public AvaAMDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public AvaAMDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new AvaAMDialogue(player);
	}
