package content.quest.member.animalmagnetism.dialogue;

import content.quest.member.animalmagnetism.AnimalMagnetism;
import content.quest.member.animalmagnetism.cutscene.AnmaCutscene;
...
/**
 * Represents the Alice Husband dialogue plugin for Animal Magnetism quest.
 */
public final class AliceHusbandAMDialogue extends DialoguePlugin {
	...
	/**
	 * Constructs a new {@code AliceHusbandAMDialogue} {@code Object}.
	 */
	public AliceHusbandAMDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public AliceHusbandAMDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new AliceHusbandAMDialogue(player);
	}
