...
/**
 * Represents the Ali The Carter dialogue plugin.
 */
@Initializable
public class AliTheCarterDialogue extends DialoguePlugin {
    public AliTheCarterDialogue(){
        /**
         * Empty
         */
    }
    public AliTheCarterDialogue(Player player){super(player);}
    @Override
    public DialoguePlugin newInstance(Player player){return new AliTheCarterDialogue(player);}
