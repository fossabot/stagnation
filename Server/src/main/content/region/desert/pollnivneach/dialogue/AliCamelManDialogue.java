...
/**
 * Represents the Ali Camel Man dialogue plugin.
 */
@Initializable
public class AliCamelManDialogue extends DialoguePlugin {
    public AliCamelManDialogue(){
        /**
         * Empty
         */
    }
    public AliCamelManDialogue(Player player){ super(player);}

    @Override
    public DialoguePlugin newInstance(Player player){ return new AliCamelManDialogue(player);}
