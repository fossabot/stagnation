...
/**
 * Represents the Ali The Kebab Seller dialogue plugin.
 */
@Initializable
public class AliTheKebabSellerDialogue extends DialoguePlugin {
    public AliTheKebabSellerDialogue(){
        /**
         * Empty
         */
    }
    public AliTheKebabSellerDialogue(Player player){ super(player);}

    @Override
    public DialoguePlugin newInstance(Player player){return new AliTheKebabSellerDialogue(player);}
    @Override
