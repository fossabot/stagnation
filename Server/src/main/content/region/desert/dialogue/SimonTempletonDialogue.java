...
/**
 * Represents the Simon Templeton dialogue plugin.
 */
@Initializable
public final class SimonTempletonDialogue extends DialoguePlugin {
    ...
    public SimonTempletonDialogue(){
        /**
         * Empty on purpose
         */
    }

    public SimonTempletonDialogue(Player player) {
        super(player);
    }

    @Override
    public DialoguePlugin newInstance(Player player) {
        return new SimonTempletonDialogue(player);
    }
    ...
    public boolean handle(int interfaceId, int buttonId){
        ...
        int goldReward = (int)(1000 + ((getStatLevel(player, 16) / 99.0) * 9000));
        switch(stage){
            case 0:
