...
import config.Items;
import content.quest.member.holygrail.dialogue.SirGalahadHGDialogue;
...
/**
 * Represents the Galahad dialogue plugin.
 */
@Initializable
public class GalahadDialogue extends DialoguePlugin {
    ...
    public boolean open(Object... args) {
        npc = (NPC) args[0];
        if(player.getQuestRepository().hasStarted("Holy Grail")) {
            player.getDialogueInterpreter().open(new SirGalahadHGDialogue(), npc);
            stage = 999;
        } else {
