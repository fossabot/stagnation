...
import config.Items
import config.NPCs
import content.quest.member.merlinsquest.dialogue.ArheinMCDialogue
import core.api.*
...
/**
 * Represents the Arhein dialogue plugin.
 */
@Initializable
class ArheinDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage) {
            ...
            7  -> openNpcShop(player, NPCs.ARHEIN_563).also { stage = END_DIALOGUE }
