...
/**
 * Represents the Ardougne Shopkeeper dialogue plugin.
 */
@Initializable
public final class ArdougneShopkeeperDialogue extends DialoguePlugin {

	/**
	 * Constructs a new {@code ArdouShopKeeperPlugin} {@code Object}.
	 */
	public ArdougneShopkeeperDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public ArdougneShopkeeperDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new ArdougneShopkeeperDialogue(player);
	}
