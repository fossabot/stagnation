...
/**
 * Represents the Aluft Gianne Snr dialogue plugin.
 */
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            ...
            6 -> {
                ...
                val items = arrayOf(Item(Items.BATTA_TIN_2164),Item(Items.GIANNE_DOUGH_2171),Item(Items.EQUA_LEAVES_2128),Item(
                    Items.GNOME_SPICE_2169),Item(Items.CHEESE_1985), Item(Items.TOADS_LEGS_2152))
            ...
            14 -> {
                ...
                val items = arrayOf(Item(Items.CRUNCHY_TRAY_2165),Item(Items.EQUA_LEAVES_2128),Item(Items.GIANNE_DOUGH_2171),Item(
                    Items.TOADS_LEGS_2152,2))
                if(!player.inventory.hasSpaceFor(*items)){
