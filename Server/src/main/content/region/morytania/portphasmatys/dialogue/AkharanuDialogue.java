...
/**
 * Represents the Akharanu dialogue plugin.
 */
@Initializable
public class AkharanuDialogue extends DialoguePlugin {
    public AkharanuDialogue() {};
    public AkharanuDialogue(Player player){super(player);}
    @Override
    public DialoguePlugin newInstance(Player player){return new AkharanuDialogue(player);}
