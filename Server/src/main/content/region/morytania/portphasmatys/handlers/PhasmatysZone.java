...
import content.region.morytania.portphasmatys.dialogue.NecrovarusDialogue;
import content.region.morytania.portphasmatys.npc.GravingasNPC;
...
public final class PhasmatysZone extends MapZone implements Plugin<Object> {
    ...
    public Pulse emptyPulse = new Pulse(5) {
        ...
        public boolean pulse() {
            ...
            setAttribute(player, "bgfirst?", false);
    ...
    public Pulse fillPulse = new Pulse(5) {
        ...
        public boolean pulse() {
            if (hasBoneInInventory(player)) {
                ...
                setAttribute(player, "bgfirst?", true);
                return true;
            }
