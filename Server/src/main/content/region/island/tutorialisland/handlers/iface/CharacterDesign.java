package content.region.island.tutorialisland.handlers.iface;
...
public final class CharacterDesign {
	...
	private static void changeLook(Player player, int index, boolean increment) {
		...
		setAttribute(player, "look-val:" + index, getValue(player, "look", index, (int) player.getAttribute("look:" + index, 0), increment));
	}
