...
/**
 * Represents the Cave Monk dialogue plugin.
 */
@Initializable
public final class CaveMonkDialogue extends DialoguePlugin {
	 ...
	 */
	public CaveMonkDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new CaveMonkDialogue(player);
	}
