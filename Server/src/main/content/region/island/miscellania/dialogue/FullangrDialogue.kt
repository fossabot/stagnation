...
/**
 * Represents the Fullangr dialogue plugin.
 */
@Initializable
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            ...
            1 -> when(buttonId){
                ...
                2 -> player(FacialExpression.NEUTRAL, "Good day.").also { stage = 99 }
            }
            10 -> npc(FacialExpression.OLD_DEFAULT,"I'm working on the digging, of course.", "It's a small excavation, so only two of us ", "can work on it at a time.").also { stage = 99 }
            99 -> end()
        }
        return true
    }
