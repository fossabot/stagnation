...
/**
 * Represents the Murky Matt dialogue plugin.
 */
@Initializable
class MurkyMattDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            4 -> when (buttonId) {
                ...
                3 -> player(FacialExpression.HALF_GUILTY, "I got to go, erm, swab some decks! Yarr!").also { stage = END_DIALOGUE }
            }
