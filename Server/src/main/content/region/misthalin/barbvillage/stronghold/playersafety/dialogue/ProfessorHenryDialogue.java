package content.region.misthalin.barbvillage.stronghold.playersafety.dialogue;

import config.Items;
import content.region.misthalin.barbvillage.stronghold.playersafety.StrongHoldOfPlayerSafetyPlugin;
...
/**
 * Represents the Professor Henry dialogue plugin.
 */
public class ProfessorHenryDialogue extends DialoguePlugin {
	...
	public boolean handle(int interfaceId, int buttonId) {
		...
		case 9:
			...
			break;
		case 10:
			sendNormalDialogue(npc, FacialExpression.HALF_GUILTY, "Here you can take part in the Player Safety test: a set", "of valuable lessons to learn about staying safe in ", "Gielinor.");
			increment();
			break;
		case 11:
