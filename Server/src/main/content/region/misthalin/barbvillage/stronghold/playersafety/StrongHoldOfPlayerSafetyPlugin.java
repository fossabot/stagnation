...
import content.region.misthalin.barbvillage.stronghold.playersafety.dialogue.GuardDialoguePlugin;
import content.region.misthalin.barbvillage.stronghold.playersafety.dialogue.PlayerSafetyTestDialogue;
import content.region.misthalin.barbvillage.stronghold.playersafety.dialogue.ProfessorHenryDialogue;
...
public class StrongHoldOfPlayerSafetyPlugin implements Plugin<Object> {
	...
	public Plugin<Object> newInstance(Object object) throws Throwable {
		...
		ClassScanner.definePlugin(new PlayerSafetyTestDialogue());
