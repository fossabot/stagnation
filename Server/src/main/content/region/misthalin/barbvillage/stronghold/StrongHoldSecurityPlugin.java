...
import content.region.misthalin.barbvillage.stronghold.dialogue.BoxOfHealthDialogue;
import content.region.misthalin.barbvillage.stronghold.dialogue.CradleOfLifeDialogue;
import content.region.misthalin.barbvillage.stronghold.dialogue.GiftOfPeaceDialogue;
import content.region.misthalin.barbvillage.stronghold.dialogue.GrainOfPlentyDialogue;
		...
		public boolean handle(int interfaceId, int buttonId) {
			switch (stage) {
				...
				case 901:
					...
					interpreter.sendDialogues(player, FacialExpression.FRIENDLY, "Oh my! I just got sucked through that door... what a", "weird feeling! Still, I guess I should expect it as these", "evidently aren't your average kind of doors.... they talk", "and look creepy!");
					stage = 902;
					break;
				case 902:
					end();
				...
				case 99:
					...
					break;
				case 1000:
					interpreter.sendOptions("Select an Option", "No, it might steal my password.", "I'll gave it a try and see if I like it.", "Sure, he's used it a lot, so can I.");
					stage = 10001;
					break;
				case 10001:
					switch (buttonId) {
				...
				case 301:
					switch (buttonId) {
						case 1:
							...
							break;
						case 2:
							interpreter.sendDialogues(npcId, FacialExpression.OLD_NORMAL, "Wrong! " + GameWorld.getSettings().getName() + " values players opinions, but we use polls", "and forums to see what you think. The recoveries are not there to gain personal", "information about anybody but to protect your account.", "Never use personal details");
							stage = 99;
							break;
						case 3:
				...
				case 601:
					switch (buttonId) {
						case 1:
							interpreter.sendDialogues(npcId, FacialExpression.OLD_NORMAL, "Wrong! " + GameWorld.getSettings().getName() + " never uses email to contact you, this is a", "scam and a fake, do not reply to it and delete it", "straight away. " + GameWorld.getSettings().getName() + " will only contact you through your", "Game Inbox available on our website.");
							stage = 99;
							break;
						case 2:
				...
				case 801:
					switch (buttonId) {
						case 1:
							...
							break;
						case 2:
							interpreter.sendDialogues(npcId, FacialExpression.OLD_NORMAL, "Wrong! This will almost certainly lead to your account", "being hijacked. No website can make you a moderator", "as they are hand picked by " + GameWorld.getSettings().getName() + ".");
							stage = 99;
							break;
						case 3:
				...
				case 1901:
					switch (buttonId) {
						case 1:
							...
							break;
						case 2:
							interpreter.sendDialogues(npcId, FacialExpression.OLD_NORMAL, "Correct! " + GameWorld.getSettings().getName() + " will not block your PIN so don't type", "it! Never use personal details for", "recoveries or bank PINs!");
							stage = 69;
							break;
					}
					break;
				...
				case 1101:
					switch (buttonId) {
						case 1:
							...
							break;
						case 2:
							interpreter.sendDialogues(npcId, FacialExpression.OLD_NORMAL, "Correct! This is the safest, both in terms of security", "and keeping your items! Leaving you character logged", "in can also allow someone to steal your items or entire", "account!");
							stage = 69;
							break;
						case 3:
							interpreter.sendDialogues(npcId, FacialExpression.OLD_NORMAL, "Wrong! You should logout in case you are attacked or", "receive a random event. Leaving your character logged", "in can also allow someone to steal your items or entire", "account!");
					...
					break;
				case 1111:
					interpreter.sendOptions("Select an Option", "On " + GameWorld.getSettings().getName() + " and all fansites.", "Only on the " + GameWorld.getSettings().getName() + " website.", "On all websites I visit.");
					stage = 1112;
					break;
				case 1112:
					switch (buttonId) {
				...
				case 1201:
					switch (buttonId) {
						case 1:
							interpreter.sendDialogues(npcId, FacialExpression.OLD_NORMAL, "This is a bad idea as if someone happens to find out your bank", "PIN on " + GameWorld.getSettings().getName() + ", they then have access to your bank account.");
							stage = 99;
							break;
						case 2:
				...
				case 1501:
					...
					break;
				case 1600:
					interpreter.sendOptions("Select an Option", "Tell them never to use them.", "Use the Account Management section on the " + GameWorld.getSettings().getName() + " website.", "'Recover a Lost Password' section on the " + GameWorld.getSettings().getName() + " website.");
					stage = 1601;
					break;
				case 1601:
					if (buttonId == 1) {
						...
						interpreter.sendDialogues(npcId, FacialExpression.OLD_NORMAL, "Wrong! If you use the Account Management section to", "change your recovery questions, it will take 14 days", "to come into effect, someone may have access to your", "account this time.");
						stage = 99;
					} else if (buttonId == 3) {
				...
				case 1701:
					switch (buttonId) {
						...
						case 2:
							...
							break;
						case 3:
							interpreter.sendDialogues(npcId, FacialExpression.OLD_NORMAL, "Wrong! " + GameWorld.getSettings().getName() + " never ask for your account", "information especially to become a player moderator.", "Press the 'Report Abuse' button and fill in the offending player's", "name and the correct category.");
							stage = 99;
							break;
					}
					break;
