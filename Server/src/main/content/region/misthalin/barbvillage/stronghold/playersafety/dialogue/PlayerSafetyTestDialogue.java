 ...
 */
public class PlayerSafetyTestDialogue extends DialoguePlugin {
	 ...
	 */
	public PlayerSafetyTestDialogue(Player player) {
		super(player);
	}
	 ...
	 */
	public PlayerSafetyTestDialogue() {
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new PlayerSafetyTestDialogue(player);
	}
	...
	public boolean close() {
		setAttribute(player, "s-stage", stage);
		return super.close();
	}
