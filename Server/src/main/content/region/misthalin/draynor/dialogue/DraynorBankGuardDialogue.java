...
/**
 * Represents the Draynor Bank Guard dialogue plugin.
 */
@Initializable
public final class DraynorBankGuardDialogue extends DialoguePlugin {
	 ...
	 */
	public DraynorBankGuardDialogue() {
		/**
		 * empty.
		 */
	}
	 ...
	 */
	public DraynorBankGuardDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new DraynorBankGuardDialogue(player);
	}
