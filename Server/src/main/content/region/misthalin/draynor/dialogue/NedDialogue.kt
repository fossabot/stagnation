...
import config.Items
import config.NPCs
import content.global.diary.dialogue.NedDiaryDialogue
import content.quest.free.dragonslayer.dialogue.NedDSDialogue
import content.quest.free.princealirescue.dialogue.NedPARDialogue
import core.api.*
...
/**
 * Represents the Ned dialogue plugin.
 */
class NedDialogue(player: Player? = null) : DialoguePlugin(player) {

    /*
    Info: Retired sailor, works as a rope maker in Draynor Village.
    Location in-game: -
     */
