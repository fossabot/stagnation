...
import content.region.misthalin.lumbridge.dialogue.LumbridgeBobDialogue;
...
public final class BobRepairItem extends UseWithHandler {
	...
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		...
		ClassScanner.definePlugin(new LumbridgeBobDialogue());
		return this;
	}
	...
	public boolean handle(NodeUsageEvent event) {
		...
		if (repair == null && !LumbridgeBobDialogue.BarrowsEquipment.isBarrowsItem(event.getUsedItem().getId())) {
