...
/**
 * Represents the Barfy Bil dialogue plugin.
 */
@Initializable
public final class BarfyBillDialogue extends DialoguePlugin {

	public BarfyBillDialogue() {}

	public BarfyBillDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new BarfyBillDialogue(player);
	}
