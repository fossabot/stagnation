...
/**
 * Represents the Bob dialogue plugin.
 */
public final class LumbridgeBobDialogue extends DialoguePlugin {
	...
	public LumbridgeBobDialogue(Player player) {
		super(player);
	}
	...
	public DialoguePlugin newInstance(Player player) {
		return new LumbridgeBobDialogue(player);
	}
