...
/**
 * Represents the Miltog dialogue plugin.
 */
@Initializable
class MiltogDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage) {
            ...
            3 -> openNpcShop(player, NPCs.MILTOG_5781).also { end(); stage = END_DIALOGUE }
