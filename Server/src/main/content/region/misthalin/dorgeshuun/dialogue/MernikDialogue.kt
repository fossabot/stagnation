...
/**
 * Represents the Mernik dialogue plugin.
 */
@Initializable
class MernikDialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            ...
            9 -> npcl(FacialExpression.OLD_NORMAL,"Well don't blame me if he doesn't want to talk to you either!")
