...
/**
 * Represents the Hegir dialogue plugin.
 */
@Initializable
class HegirDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            15 -> sendNPCDialogue(player, NPCs.HAERA_2189, "Stop talking to that human and get back in here before I have a task for you!").also { stage++ }
            ...
            19 ->{
                ...
                sendChat(findNPC(NPCs.HEGIR_2188)!!, randomShouts.random())
            }
        }
        return true
    }
