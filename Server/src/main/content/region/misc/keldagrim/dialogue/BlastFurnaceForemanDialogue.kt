...
/**
 * Represents the Blast Furnace Foreman dialogue plugin.
 */
@Initializable
class BlastFurnaceForemanDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage) {
            ...
            1 -> showTopics(
                    ...
                    Topic(FacialExpression.FRIENDLY, "Ask about dragon metal.", 52),
            ...
            56 -> {
                npcl(FacialExpression.OLD_DEFAULT, "Yes, you'll need very high heat resistance to work with difficult materials. I've got a very special type of hammer, which I hold back for experienced smiths - I call it the blast fusion hammer. It's very hard-wearing")
                stage = 57
            }
            57 -> {
                npcl(FacialExpression.OLD_DEFAULT,"and of the utmost quality.")
                stage = 58
            }
            58 -> {
            ...
            64 -> when(buttonId) {
                1 -> if (!removeItem(player, Item(Items.COINS_995, 1000000))) {
                    npcl(FacialExpression.OLD_DEFAULT, "You don't have enough money to buy a blast fusion hammer, come back when you can afford one.")
                    stage = 100
                } else {
            ...
            65 -> {
                npcl(FacialExpression.OLD_DEFAULT, "No problem. Just hand me the hammer you want to return and I'll tell you how much I can give you back.")
                stage = 66
            }
            66 -> {
            ...
            68 -> {
                npcl(FacialExpression.OLD_DEFAULT, "An interesting question, which, I'm sorry to say, I can't answer. Top secret dwarven technological and industrial secrets, you see.")
                stage = 69
            }
            69 -> {
            ...
            72 -> {
                npcl(FacialExpression.OLD_DEFAULT, "Very well. Us dwarves have been working on a series of very important metallurgical experiements. We found some quite interesting rock formations, in a place that shall remain nameless,")
                stage = 73
            }
            73 -> {
                npcl(FacialExpression.OLD_DEFAULT, "and our experiments developed and evolved until we came up with the blast fusion hammer. The hammer is capable of working even the strongest and most magical of metals!")
                stage = 100
            }
            100 -> end()
        }
    ...
    class ChatPulse(val npc: NPC) : Pulse() {
        companion object {
            val MESSAGES = arrayOf("Good work soldier!", "Push it!", "Work it!", "The dummy is the enemy. Kill it!", "Put your back into it soldier!", "You're not out for a sunday stroll soldier!", "My daughter can hit harder than that!", "I want to see you sweat!", "Keep it up soldier!")
        }
        ...
        override fun pulse(): Boolean {
            ticks++
            if(ticks % 100 == 0) {
                sendChat(npc, MESSAGES[RandomFunction.random(MESSAGES.size)])
            }
            return true
        }
    }
