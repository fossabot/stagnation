...
/**
 * Represents the Gauss dialogue plugin.
 */
@Initializable
class GaussDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            7 -> npc(FacialExpression.OLD_DEFAULT, "No no, get a pint of beer, jugs of wine aren't", "good to toast with Wine stains are terribly hard", "to wash out of a beard.").also { stage++ }
            8 -> end()
        }
        return true
    }
