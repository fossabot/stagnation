...
/**
 * Represents the dialogue used for Dwarven Ferryman Forth.
 */
@Initializable
class DwarvenFerrymanForthDialogue(player: Player? = null) : DialoguePlugin(player) {
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            6 -> showTopics(
                Topic(FacialExpression.FRIENDLY, "I'd like to go further downstream.", 7),
                Topic(FacialExpression.FRIENDLY, "Yes please.", 12),
            ...
            9 -> npcl(
                FacialExpression.OLD_DEFAULT,
                "Sorry, I'm just a simple ferryman, I only go across."
            ).also { stage++ }
            ...
            11 -> playerl(FacialExpression.FRIENDLY, "Thanks.").also {
                stage = END_DIALOGUE
            }
            ...
            13 -> npcl(FacialExpression.OLD_DEFAULT, "Come back later.").also {
                stage = END_DIALOGUE
            }
        }
        return true
