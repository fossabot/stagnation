...
/**
 * Represents the TzHaar Mej Kah dialogue plugin.
 */
@Initializable
public class TzHaarMejKahDialogue extends DialoguePlugin {

	public TzHaarMejKahDialogue() {
	...
	public DialoguePlugin newInstance(Player player) {
		...
		return new TzHaarMejKahDialogue(player);
	}
