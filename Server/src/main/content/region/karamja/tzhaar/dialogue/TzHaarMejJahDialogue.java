...
/**
 * Represents the TzHaar Mej Jah dialogue plugin.
 */
@Initializable
public class TzHaarMejJahDialogue extends DialoguePlugin {
	private static final Item APPEARANCE_FEE = new Item(6529, 8000); // 8000 tokkul, about the same as you get from failing jad

	public TzHaarMejJahDialogue() {

	}

	public TzHaarMejJahDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new TzHaarMejJahDialogue(player);
	}
