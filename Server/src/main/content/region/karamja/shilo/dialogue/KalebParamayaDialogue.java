...
/**
 * Represents the Kaleb Paramaya dialogue plugin.
 */
@Initializable
public class KalebParamayaDialogue extends DialoguePlugin {
	/**
	 * Constructs a new {@code KalebParamaya} {@code Object}
	 */
	public KalebParamayaDialogue() {
		/*
		 * empty.
		 */
	}
	 ...
	 */
	public KalebParamayaDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new KalebParamayaDialogue(player);
	}
