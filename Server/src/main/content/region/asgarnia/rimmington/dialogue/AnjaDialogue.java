...
/**
 * Represents the Anja dialogue plugin.
 */
@Initializable
public final class AnjaDialogue extends DialoguePlugin {
	 ...
	 */
	public AnjaDialogue(Player player) {
		super(player);
	}

	@Override
	public DialoguePlugin newInstance(Player player) {
		return new AnjaDialogue(player);
	}
