...
/**
 * Represents the Mining Guild Dwarf dialogue plugin.
 */
@Initializable
class MiningGuildDwarfDialogue(player: Player? = null) : DialoguePlugin(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            0 -> sendDialogueOptions(player,"What would you like to say?", "What have you got in the Guild?", "What do you dwarves do with the ore you mine?", "No thanks, I'm fine.").also { stage = 1 }
            1 -> when (buttonId) {
                1 -> playerl(FacialExpression.ASKING, "What have you got in the Guild?").also { stage = 2 }
                2 -> playerl(FacialExpression.ASKING, "What do you dwarves do with the ore you mine?").also { stage = 5 }
                3 -> playerl(FacialExpression.NEUTRAL, "No thanks, I'm fine.").also { stage = END_DIALOGUE }
            }
            ...
            6 -> playerl(FacialExpression.HALF_THINKING, "I don't see many dwarves here.").also { stage++ }
    ...
    override fun newInstance(player: Player): DialoguePlugin {
        return MiningGuildDwarfDialogue(player)
    }
