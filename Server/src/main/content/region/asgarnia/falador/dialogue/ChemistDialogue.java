...
import static core.api.ContentAPIKt.setComponentVisibility;

/**
 * Represents the Chemist dialogue plugin.
 */
@Initializable
public final class ChemistDialogue extends DialoguePlugin {
    ...
    public boolean open(Object... args) {
        ...
        interpreter.sendOptions("Do you want to talk about lamps?", "Yes.", "No.", "No, I'm more interested in impling jars.", "About the Achievement Diary...");
        stage = 0;
