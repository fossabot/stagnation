...
import config.Items;
import content.global.skill.member.construction.CrestType;
...
/**
 * Represents the Sir Renitee dialogue plugin.
 */
@Initializable
    ...
    public boolean handle(int interfaceId, int buttonId) {
        switch (stage) {
            ...
            case 40:
                ...
                break;
            case 100:
                interpreter.sendDialogues(npc, FacialExpression.HALF_GUILTY, "Hmm, well, mmm, do you have a family crest? I keep", "track of every Gielinor family, you know, so I might", "be able to find yours.");
                stage = 110;
                break;
            case 110:
