...
object ServerConfigParser {
    ...
    private fun parseServerSettings(){
        ...
        ServerConstants.RULES_AND_INFO_ENABLED = data.getBoolean("world.show_rules", false)
        ...
        ServerConstants.WATCHDOG_ENABLED = data.getBoolean("server.watchdog_enabled", false)
