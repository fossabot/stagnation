...
public class AIPlayer extends Player {
    ...
    private static final List<String> aiNames = new ArrayList<String>();
    ...
    /**
     * Generates bot stats/equipment/etc based on copyLine
     */
    ...
    private void giveArmor() {
        ...
        equipIfExists(new Item(parseData(2)), EquipmentContainer.SLOT_HAT);
        equipIfExists(new Item(parseData(3)), EquipmentContainer.SLOT_CAPE);
        equipIfExists(new Item(parseData(4)), EquipmentContainer.SLOT_AMULET);
        equipIfExists(new Item(parseData(5)), EquipmentContainer.SLOT_WEAPON);
        equipIfExists(new Item(parseData(6)), EquipmentContainer.SLOT_CHEST);
        equipIfExists(new Item(parseData(7)), EquipmentContainer.SLOT_SHIELD);
        equipIfExists(new Item(parseData(9)), EquipmentContainer.SLOT_LEGS);
        equipIfExists(new Item(parseData(11)), EquipmentContainer.SLOT_HANDS);
        equipIfExists(new Item(parseData(12)), EquipmentContainer.SLOT_FEET);
    }

    private int parseData(int index) {
        return Integer.parseInt(copyLine.split(":")[index]);
    }
    ...
    public static String getRandomName(){
        int index = (RandomFunction.random(aiNames.size()));
        String name = aiNames.get(index);
     ...
     * Get a bot content
     */
    public static void updateRandomLine(String fileName) {
    ...
    private static String retrieveRandomName(String fileName) {
        do {
            updateRandomLine(fileName);
        } while (copyLine.startsWith("#") || copyLine.contains("_") || copyLine.contains(" ")); //Comment
        return copyLine.split(":")[0];
    }
