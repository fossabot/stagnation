...
class GrimDialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            ...
            18 -> npcl(FacialExpression.NEUTRAL, "It is a decorative symbol of your engagement in this activity. Bring me candies, and it can be yours.").also { setAttribute(player, "/save:hween2:grim_spoken",true); stage++ }
            19 -> npc("NOW GET TO WORK!").also { setAttribute(player, "/save:hween2:grim_spoken",true); stage = 1000 }
    ...
    fun buyStaff(player: Player){
        setAttribute(player, "/save:sotr:purchased", true)
    ...
    fun buyRecolor1(player: Player){
        setAttribute(player, "/save:sotr:recolor1", true)
    ...
    fun buyRecolor2(player: Player){
        setAttribute(player, "/save:sotr:recolor2", true)
        removeCandies(player, 10)
        stage = 104
        handleRewardShop(player, -1)
    }
